...
export default function FinalAssessmentSuccessPage2({ handleBackButton, formObject }) {
      ...
      <Loading
        ...
        customComponent={
          <VStack space="0" flex="1" width={width}>
            <VStack bg={colors.scoreCardBg1} pb="100px" pt="32px" alignItems="center" space={4}>
              <img src={nipun_ready_badge} alt="nipun badge" style={{maxWidth: '300px', width: '70%'}} />
              <img src={nipun_ready_kids} alt="nipun kids" style={{maxWidth: '190px', width: '70%'}} />
            </VStack>
            <Box
              {...{
                mx:'auto',
