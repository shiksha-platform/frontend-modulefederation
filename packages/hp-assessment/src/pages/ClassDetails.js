import {
  ...
  telemetryFactory,
  capture,
  classRegistryService, hpAssessmentRegistryService, assessmentRegistryService
...
export default function ClassDetails({appName}) {
  ...
  const classId = localStorage.getItem('hp-assessment-groupId') || '2bd698db-49a4-4811-943d-9954f8c1f377';
