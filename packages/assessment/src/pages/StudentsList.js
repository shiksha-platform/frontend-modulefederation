import { classRegistryService, H3, Layout, overrideColorTheme } from "@shiksha/common-lib";
...
export default function StudentsListPage({classId, setPageName, handleBackButton, chooseAssessmentTypeModal, handleSelectedStudent, selectedStudent, handleStudentPageNext}) {
  ...
  const fetchClassDetails = async () => {
    ...
    setTitle(schoolDetails && schoolDetails.name ? (`${schoolDetails.name} ${schoolDetails?.section}`) : '' )
  }
  useEffect(() => {
    fetchClassDetails();
  }, [])
