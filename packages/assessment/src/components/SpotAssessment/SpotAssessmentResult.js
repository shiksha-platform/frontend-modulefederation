              ...
              <VStack space={3}>
                <Box mx="auto">
                  <Avatar
                    ...
                    source={{
                      ...
                      uri: studentDetails.image && studentDetails.image !== ""
                ...
                <Box>
                  <H2>{studentDetails.fullName}</H2>
                  {
                    ...
                    <BodyMedium color={colors.gray}>`MR. ${studentDetails.fathersName}`</BodyMedium>
                  }
                </Box>
              </VStack>
            </Box>
  ...
  return (
    <Layout isDisabledAppBar={true}>
      <Loading
        ...
        height={height}
        customComponent={
          scorePercent >= 75 ? <SuccessComponent /> :
            (scorePercent < 75 && scorePercent >= 35 ? <OKComponent /> :
              <FailureComponent /> )
        }
      />
      <Actionsheet
      ...
      >
        ...
        <Box w="100%" p={4} justifyContent="center" bg={colors.white}>
          <Actionsheet.Item onPress={() => setNextOption("typeSelection")}>
            <BodyLarge textTransform="none" color={
              nextOption === 'typeSelection'
                ? "black"
                : colors.gray
            }>Continue another type of test with same student</BodyLarge>
          </Actionsheet.Item>
          <Actionsheet.Item onPress={() => setNextOption("repeat")}>
            <BodyLarge textTransform="none" color={
              nextOption === 'repeat'
                ? "black"
                : colors.gray
            }>Repeat test with another student</BodyLarge>
          </Actionsheet.Item>
          <Actionsheet.Item onPress={() => setNextOption("similar")}>
            <BodyLarge textTransform="none" color={
              nextOption === 'similar'
                ? "black"
                : colors.gray
            }>Give similar test to another student</BodyLarge>
          </Actionsheet.Item>
