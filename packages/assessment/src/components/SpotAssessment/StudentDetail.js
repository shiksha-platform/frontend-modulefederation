        ...
        <VStack space="0">
          <Box p="4" bg="green.200" roundedTop="6">
            <HStack justifyContent={"center"} alignItems="center">
              ...
              <Text color="green.600" bold> {t("YAY! you got most of the answers right!")}</Text>
            </HStack>
          </Box>
          <Box p="4" textAlign="center" bg="orange.100" >
            <Text fontSize={24} color="green.600" bold mb="0">72 %</Text>
            <Text color="muted.600" fontSize="xs">{t("Total Score")}</Text>
            <HStack justifyContent={"center"} alignItems="center">
