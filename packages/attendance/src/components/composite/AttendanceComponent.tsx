...
<<<<<<< HEAD:packages/attendance/src/components/AttendanceComponent.js
...
=======
>>>>>>> f727083 (Added some more utilities):packages/attendance/src/components/composite/AttendanceComponent.tsx
=======
>>>>>>> 66809e8 (Refactored some more components)
=======
>>>>>>> 012be5e (Some more optmisations in getIcon)
=======
>>>>>>> e0145ec (Some readjustment)
=======
>>>>>>> e8cb420 (Refactored attendance component a bit)
...
=======
    if (dataObject.attendanceId) {
      ...
      setLoading({});
      setShowModal(false);
>>>>>>> 17483c3 (Major refactoring done)
    }
  };
  return (
