...
import { ProgressBar, BodySmall, Subtitle, Caption } from "@shiksha/common-lib";
...
const ReportSummary: React.FC<IReport> = ({
  students,
  attendance,
  title,
  page,
  ...
  const { design } = useDesign({ attendance, page, calendarView, colorTheme });
