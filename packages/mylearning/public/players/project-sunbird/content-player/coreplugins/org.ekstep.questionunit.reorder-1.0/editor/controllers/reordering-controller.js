 ...
 */
angular
  .module("reorderingApp", ["org.ekstep.question"])
  .controller("reorderingQuestionFormController", [
    "$scope",
    "$rootScope",
    "questionServices",
    function ($scope, $rootScope, questionServices) {
      ...
      $scope.reorderingFormData.question.text =
        temp.length > 0
          ? temp
          : "Arrange the given words in proper order to form a sentence.";
      var questionInput = CKEDITOR.replace("reorderingQuestionBox", {
      ...
      $scope.init = function () {
        ...
        ecEditor.addEventListener(
          "org.ekstep.questionunit.reorder:editquestion",
          $scope.editReorderQuestion,
          $scope
        );
      ...
      $scope.formValidation = function () {
        ...
        formValid =
          reorderFormQuestionText.length > 0 &&
          reorderFormSentenceText.length > 0;
