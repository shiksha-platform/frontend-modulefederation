describe("Ekstep Assesment Browser Plugin:", function () {
  ...
  beforeAll(function (done) {
    ContentEditorTestFramework.init(function () {
      ...
      org.ekstep.contenteditor.stageManager.currentStage = org.ekstep
        .contenteditor.stageManager.currentStage
        ? org.ekstep.contenteditor.stageManager.currentStage
        : { id: "1234" };
  ...
  describe("Quiz plugin test cases", function () {
    it("Should invoke Meta Services and get Category Data", function (done) {
      var respCat = {
        data: {
          ...
          ver: "1.0",
          ts: "2018-06-01T11:35:01ZZ",
          params: {
            resmsgid: "fc139cb7-d62c-4a90-ab2c-3b02cba7e002",
            msgid: null,
            err: null,
            status: "successful",
            errmsg: null,
          ...
          result: {
            framework: {
              ...
              channels: [
                {
                  ...
                  description: "Channel for Org 001",
                  index: null,
                  status: null,
                  depth: null,
                  mimeType: null,
              ...
              appId: "ekstep_portal",
              name: "NCF framework",
              lastUpdatedOn: "2018-05-08T19:01:48.265+0000",
              categories: [
                {
      ...
      ecEditor.getService("meta").getCategorys = jasmine
        .createSpy()
    ...
    it("Should invoke Meta Services and get Assesment Data", function (done) {
      ...
      ecEditor.getService("meta").getDefinitions = jasmine
        .createSpy()
        .and.callFake(function (data, callback) {
    ...
    it("Should invoke getResourceBundles method", function (done) {
      var resp = {
        assessment: {
          type: ["embedded", "mcq", "ftb", "mtf", "recognition", "other"],
        },
      };
      var resourceResp = {
        data: {
          id: "ekstep.config.resourebundles.read",
          ver: "1.0",
          ts: "2018-06-04T09:41:30ZZ",
          params: {
            resmsgid: "03de0a76-f7cc-4e2c-a767-047154da49d6",
            msgid: null,
            err: null,
            status: "successful",
            errmsg: null,
          ...
          result: {
            en: {
              "Serial Books": "Serial Books",
              objects: "Objects Used in the Content",
      ...
      ecEditor.getService("meta").getResourceBundles = jasmine
        .createSpy()
        .and.callFake(function (data, callback) {
    ...
    it("Should invoke getQuestions method", function (done) {
      var resp = {
        data: {
          ...
          ver: "3.0",
          ts: "2018-06-04T11:15:36ZZ",
          params: {
            resmsgid: "c4d33a48-72f1-4d14-95fd-234d6a2e7c43",
            msgid: null,
            err: null,
            status: "successful",
            errmsg: null,
          ...
          result: {
            ...
            items: [
              {
                template: "1.mtf.lhs.txt.aud-rhs.txt.aud",
                code: "org.ekstep.assessmentitem.do_20045521",
                qlevel: "MEDIUM",
                channel: "in.ekstep",
                language: ["Kannada"],
                medium: "Kannada",
                ...
                createdOn: "2016-08-18T08:35:30.230+0000",
                objectType: "AssessmentItem",
                gradeLevel: ["KG", "Class 1", "Class 2"],
                appId: "qa.ekstep.in",
                lastUpdatedOn: "2017-06-07T07:21:35.042+0000",
                used_for: "worksheet",
                model: "null",
                owner: "404",
                identifier: "do_20045521",
                question: " ಹೊಂದಿಸಿ ಬರೆಯಿರಿ:",
                consumerId: "2c43f136-c02f-4494-9fb9-fd228e2c77e6",
                portalOwner: "404",
                graph_id: "domain",
                nodeType: "DATA_NODE",
                version: 1,
                versionKey: "1496820095042",
                framework: "NCF",
                concepts: ["LO44"],
                createdBy: "404",
                max_score: 1,
                name: "ಹೊಂದಿಸಿ ಬರೆಯಿರಿ:",
                template_id: "domain_7330",
                node_id: 43542,
              },
              {
                template: "org.ekstep.mcq.t.ta",
                code: "ek.n.ib.d.ss.bp3.5",
                ...
                createdOn: "2016-06-16T14:01:04.733+0000",
                objectType: "AssessmentItem",
                feedback: "दोबारा कोशिश करं",
                gradeLevel: ["Class 3"],
                appId: "qa.ekstep.in",
                options: [
                  {
                    value: { type: "mixed", text: "7", asset: "7" },
                    answer: false,
                  },
                  {
                    value: { type: "mixed", text: "49", asset: "49" },
                    answer: false,
                  },
                  {
                    value: { type: "mixed", text: "35", asset: "35" },
                    answer: false,
                  },
                  {
                    value: { type: "mixed", text: "6", asset: "6" },
                    answer: true,
                  },
                ],
                lastUpdatedOn: "2017-06-07T07:17:28.205+0000",
                used_for: "worksheet",
                owner: "Feroz",
                identifier: "ek.n.ib.d.ss.bp3.5",
                question: "42 ÷ 7 = ?",
                consumerId: "2c43f136-c02f-4494-9fb9-fd228e2c77e6",
                portalOwner: "128",
                graph_id: "domain",
                nodeType: "DATA_NODE",
                version: 1,
                versionKey: "1496819848205",
                framework: "NCF",
                createdBy: "128",
                max_score: 1,
                name: "भाग",
                num_answers: 1,
                template_id: "domain_3490",
                node_id: 12385,
              },
            ],
          },
      ...
      ecEditor.getService("assessment").getQuestions = jasmine
        .createSpy()
        .and.callFake(function (data, callback) {
          return callback(undefined, resp);
        });
    ...
    it("Should invoke getItem method", function (done) {
      var resp = {
        data: {
          ...
          ver: "1.0",
          ts: "2018-06-04T13:56:54ZZ",
          params: {
            resmsgid: "c290d853-0ac2-464a-a76f-53947666896d",
            msgid: null,
            err: null,
            status: "successful",
            errmsg: null,
              ...
              media: [
                {
                  id: "do_20045512",
                  type: "image",
                  src: "https://qa.ekstep.in/assets/public/content/bear_404_1471505641_1471505737947.png",
                  asset_id: "do_20045512",
                },
                {
                  id: "do_20045520",
                  type: "image",
                  src: "https://qa.ekstep.in/assets/public/content/deer_404_1471508887_1471508983946.png",
                  asset_id: "do_20045520",
                },
                {
                  id: "do_20045339",
                  type: "image",
                  src: "https://qa.ekstep.in/assets/public/content/img_11_404_1470903015_1470903099502.jpg",
                  asset_id: "do_20045339",
                },
                {
                  id: "do_20045513",
                  type: "image",
                  src: "https://qa.ekstep.in/assets/public/content/donkey_404_1471505828_1471505925325.jpg",
                  asset_id: "do_20045513",
                },
                {
                  id: "do_20045519",
                  type: "image",
                  src: "https://qa.ekstep.in/assets/public/content/elephant_404_1471508688_1471508785049.png",
                  asset_id: "do_20045519",
                },
              ],
              type: "mtf",
              title: "ಹೊಂದಿಸಿ ಬರೆಯಿರಿ:",
      ...
      ecEditor.getService("assessment").getItem = jasmine
        .createSpy()
        .and.callFake(function (data, callback) {
