...
org.ekstep.questionsetPreview.EditorPlugin =
  org.ekstep.contenteditor.basePlugin.extend({
    ...
    getQuestionPreviwContent: function (questionSet) {
      ...
      story.theme.stage[0]["org.ekstep.questionset"]["org.ekstep.question"] =
        qAndMediaObj["org.ekstep.question"];
      ...
      story.theme["plugin-manifest"].plugin =
        ManifestGenerator.getPluginManifest(); // eslint-disable-line no-undef
      return story;
    },
