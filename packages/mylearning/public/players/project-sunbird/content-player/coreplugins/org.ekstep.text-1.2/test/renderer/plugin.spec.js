var textSample = {
  ...
  fontsize: 48,
  weight: "",
  id: "48bcb58a-3e08-4c2d-a380-0bb1d7d923aa",
  config: {
    __cdata:
      '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"text":"Hello World","color":"#000000","fontfamily":"NotoSans","fontsize":18,"fontweight":false,"fontstyle":false,"align":"left"}',
  },
  pluginType: "org.ekstep.text",
};
var htextSample = {
  x: 10,
  y: 20,
  ...
  fontsize: 48,
  weight: "",
  id: "8aa2011e-c774-49cc-8278-3881e4181e8c1",
  config: {
    __cdata:
...
describe("Super Text plugin test cases", function () {
  beforeAll(function (done) {
    var instance = this;
    org.ekstep.pluginframework.pluginManager.loadPluginWithDependencies(
      "org.ekstep.text",
      "1.1",
      "plugin",
      undefined,
      function () {
        instance.plugin = PluginManager.invoke(
          "org.ekstep.text",
          textSample,
          Renderer.theme._currentScene,
          Renderer.theme._currentScene,
          Renderer.theme
        );
        done();
  ...
  describe("Render plugin with text/htext/wordinfo", function () {
    ...
    it("Rendering wordinfo when wordinfo event(object) are available", function () {
      ...
      this.plugin._stage._data.event = {
        type: "hello_click",
        action: [
          { type: "command", command: "show", asset: "hello_info" },
          { type: "command", command: "HIDEHTMLELEMENTS", asset: "hello_info" },
        ],
      };
      this.plugin.initPlugin(wordInfoSample);
      expect(this.plugin._stage.events.event.length).toBeGreaterThan(0);
  ...
  describe("invokeController function", function () {
    ...
    it("when wordinfo controller is available in theme controller", function () {
      spyOn(this.plugin, "invokeController").and.callThrough();
      this.plugin._theme._controllerMap.dictionary = {
        _type: "data",
        _id: "data.dictionary",
        _data: {
          Hello: {
            lemma: "Hello",
            gloss: "an expression or gesture of greeting",
          },
          hello: { lemma: "hello", gloss: "an expression of greeting" },
        },
        _loaded: true,
        _model: {
          Hello: {
  ...
  it("invokeTemplate function call", function () {
    spyOn(this.plugin, "invokeTemplate").and.callThrough();
    this.plugin._plginData.template = {
      id: "infoTemplate",
      g: {
        x: "0",
        y: "0",
        ...
        h: "100",
        image: {
          asset: "org.ekstep.text.popuptint",
          x: "0",
          y: "0",
          w: "100",
          h: "100",
    ...
    expect(this.plugin.invokeTemplate.calls.count()).toEqual(1);
    expect(
      this.plugin._theme._templateMap[this.plugin._plginData.template.id]
    ).toBeDefined();
  });
