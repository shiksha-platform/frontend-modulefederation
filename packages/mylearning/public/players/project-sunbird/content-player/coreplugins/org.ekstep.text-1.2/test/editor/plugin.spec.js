...
describe("Text plugin", function () {
  ...
  beforeAll(function () {
    ...
    org.ekstep.contenteditor.mediaManager.addMedia({
      name: "10",
      id: "do_20076098",
      src: "https://dev.ekstep.in:443/assets/public/content/10_1466574879197.mp3",
      type: "audio",
    });
    $(
      '<div class="ui form" id="textEditorContainer"><div class="field"><textarea id="authoringTextEditor" placeholder="Add text here" rows="12">Plain text</textarea><div><div class="ui buttons" id="texteditorBtnGrp"><button id="authoringTextEditorCancel" class="ui secondary button">Cancel</button><div class="or"></div><button id="authoringTextEditorBtn" class="ui primary button">Done</button></div></div></div></div>'
    ).appendTo("body");
  });
  ...
  it("should create plain text", function () {
    ...
    ecEditor.dispatchEvent("org.ekstep.text:create", {
      __text: "",
      x: 10,
      y: 20,
      fontFamily: "NotoSans",
    ...
    ContentEditorTestFramework.validateObject(text1.toECML(), {
      ...
      id: text1.id,
      "config.__cdata":
        '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"text":"","color":"#000000","fontfamily":"NotoSans","fontsize":22,"fontweight":true,"fontstyle":false,"align":"left"}',
    });
  ...
  it("should crate wordinfo text", function () {
    ...
    ContentEditorTestFramework.validateObject(wordinfo_text.toECML(), {
      ...
      weight: "",
      "config.__cdata":
        '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"text":"","wordfontcolor":"#CC1234","wordhighlightcolor":"#CC1235","wordunderlinecolor":"#CC1236","color":"#000000","fontfamily":"NotoSans","fontsize":18,"fontweight":false,"fontstyle":false,"align":"center"}',
    });
  });

  it("should crate readalong text using old AT data", function () {
    ecEditor.dispatchEvent("org.ekstep.text:create", {
      __text: "Test read along text",
      x: 10,
      y: 20,
      fontFamily: "NotoSans",
      fontSize: 18,
  ...
  it("should execute modifyText func", function () {
    ...
    ecEditor.dispatchEvent("org.ekstep.text:modified", {
      clientX: 350,
      clientY: 100,
    });
  ...
  it("should getConfigManifest", function () {
    ...
    var test_getConfigManifest = text1
      .getConfigManifest()
      .forEach((element) => {
        if (element.propertyName === "stroke") {
          return false;
        }
      });
  ...
  it("should check ", function () {
    ...
    expect(text6.getOffsetPosition(text6.attributes).y).toEqual(50);
    console.log("text6_atrruiii", text6.attributes.y);
    ...
    text8 = stage.children[8];
    console.log("testName4---->", text8.editorObj.text);
    spyOn(text8, "getOffsetPosition").and.callThrough();
    //stage.pixelToPercent(text8.attributes);
    expect(text8.getOffsetPosition({ x: 15, y: 48, w: 35, h: 5.02 }).x).toEqual(
      35
    );
  });
  it("should check plugin version", function () {
