    ...
    var dialCodeController = [
      ...
      function ($scope, $controller, $filter) {
              ...
              $scope.searchDialCode(this.dialcodes, function (response) {
                if (response.isValid) {
                  ...
                  if (
                    ...
                    org.ekstep.services.stateService.create(
                      "invaliddialCodeMap"
                    );
                  }
                  org.ekstep.services.stateService.setState(
        ...
        $scope.clearDialCode = function () {
          $scope.dialcodes = "";
          var nodeId =
            org.ekstep.services.collectionService.getActiveNode().data.id;
          if (
            org.ekstep.collectioneditor.cache.nodesModified &&
            org.ekstep.collectioneditor.cache.nodesModified[nodeId]
          ) {
            org.ekstep.collectioneditor.cache.nodesModified[nodeId].metadata[
              "dialcodes"
            ] = [];
          }
          if (!org.ekstep.services.stateService.state.dialCodeMap) {
...
org.ekstep.pluginframework.pluginManager.registerPlugin(
  {
    id: "org.ekstep.unitmeta",
    ver: "1.5",
    author: "Kartheek Palla",
    title: "Collectioneditor Unit Meta plugin",
    description: "",
    publishedDate: "",
    editor: {
  ...
  org.ekstep.collectioneditor.basePlugin.extend({
    initialize: function () {
      var e = ecEditor.resolvePluginResource(
          this.manifest.id,
          this.manifest.ver,
          "editor/unitmeta.html"
        ),
        t = ecEditor.resolvePluginResource(
          this.manifest.id,
          this.manifest.ver,
          "editor/unitmetaApp.js"
        );
