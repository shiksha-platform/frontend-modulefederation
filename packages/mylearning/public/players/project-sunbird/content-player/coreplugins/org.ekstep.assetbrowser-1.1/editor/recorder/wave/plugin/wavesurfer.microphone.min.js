  ...
  (a.Microphone = {
    ...
    start: function () {
      navigator.mediaDevices
        ...
        ["catch"](this.deviceError.bind(this));
    },
    togglePlay: function () {
      this.active
    ...
    stopDevice: function () {
      if (((this.active = !1), this.disconnect(), this.stream)) {
        ...
        if (
          (("chrome" === a.browser && a.version >= 45) ||
            ("firefox" === a.browser && a.version >= 44) ||
            "edge" === a.browser) &&
          this.stream.getTracks
        )
          return void this.stream.getTracks().forEach(function (a) {
            a.stop();
          });
        this.stream.stop();
      }
    ...
    disconnect: function () {
      void 0 !== this.mediaStreamSource && this.mediaStreamSource.disconnect(),
    ...
    reloadBuffer: function (a) {
      this.paused ||
        ...
        this.wavesurfer.loadDecodedBuffer(a.inputBuffer));
    },
    gotStream: function (a) {
      (this.stream = a),
        (this.active = !0),
        this.play(),
        this.fireEvent("deviceReady", a);
    },
    destroy: function (a) {
        ...
        "undefined" != typeof window && window.navigator
          ? navigator.mozGetUserMedia
            ...
            ? ((a.browser = "edge"),
              ...
              (a.minVersion = 10547),
              a)
            : ((a.browser = "Not a supported browser."), a)
          : ((a.browser = "Not a supported browser."), a)
      );
    },
  }),
