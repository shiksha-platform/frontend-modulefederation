 ...
 * @license CC-BY-3.0 */ !(function (a, b) {
  ...
  (a.Regions = {
    ...
    enableDragSelection: function (a) {
      function b(a) {
        (e = !0),
          ...
          (f = h.wavesurfer.drawer.handleEvent(a)),
          (g = null);
      }
      function c(a) {
        (e = !1),
          g &&
            (g.fireEvent("update-end", a),
            h.wavesurfer.fireEvent("region-update-end", g, a)),
          (g = null);
      }
      function d(b) {
        if (e) {
          ...
          "undefined" != typeof b.targetTouches &&
            ...
            (b.clientX = b.targetTouches[0].clientX);
          var d = h.wavesurfer.drawer.handleEvent(b);
          g.update({
            start: Math.min(d * c, f * c),
      ...
      var e,
        ...
        g,
        h = this;
      this.wrapper.addEventListener("mousedown", b),
        this.wrapper.addEventListener("touchstart", b),
        this.wrapper.addEventListener("mouseup", c),
        this.wrapper.addEventListener("touchend", c),
        this.wrapper.addEventListener("mousemove", d),
        this.wrapper.addEventListener("touchmove", d);
    },
  }),
    (a.Region = {
        ...
        (this.wavesurfer = c),
          ...
          (this.end =
            null == b.end
              ...
              : Number(b.end)),
          (this.resize = void 0 === b.resize ? !0 : Boolean(b.resize)),
          (this.drag = void 0 === b.drag ? !0 : Boolean(b.drag)),
      ...
      render: function () {
        ...
        for (var b in this.attributes)
          a.setAttribute("data-region-" + b, this.attributes[b]);
      ...
      updateRender: function (a) {
        ...
        if (
          ((b = a
            ? Math.round(this.wavesurfer.getDuration() * a)
            : this.wrapper.scrollWidth),
          this.start < 0 &&
            ((this.start = 0), (this.end = this.end - this.start)),
          this.end > c &&
            ((this.end = c), (this.start = c - (this.end - this.start))),
          null != this.minLength &&
          ...
          for (var d in this.attributes)
            this.element.setAttribute("data-region-" + d, this.attributes[d]);
      ...
      bindInOut: function () {
        ...
        var b = function (b) {
          !a.firedIn &&
            ...
            (a.firedOut = !1),
            a.fireEvent("in"),
            a.wavesurfer.fireEvent("region-in", a)),
            !a.firedOut &&
              a.firedIn &&
              (a.start >= Math.round(100 * b) / 100 ||
                a.end <= Math.round(100 * b) / 100) &&
              ((a.firedOut = !0),
              (a.firedIn = !1),
              a.fireEvent("out"),
              a.wavesurfer.fireEvent("region-out", a));
        };
          ...
          (this.drag || this.resize) &&
            (function () {
              var b,
                c,
                d,
                e = a.wavesurfer.getDuration(),
                f = function (f) {
                  f.stopPropagation(),
                    (d = a.wavesurfer.drawer.handleEvent(f) * e),
                    "handle" == f.target.tagName.toLowerCase()
                      ? (c = f.target.classList.contains(
                ...
                h = function (f) {
                  if (b || c) {
                    ...
                    (d = g),
                      a.drag && b && a.onDrag(h),
                      a.resize && c && a.onResize(h, c);
                  }
                };
              a.element.addEventListener("mousedown", f),
                a.wrapper.addEventListener("mousemove", h),
                document.body.addEventListener("mouseup", g),
                a.on("remove", function () {
                  document.body.removeEventListener("mouseup", g),
                    a.wrapper.removeEventListener("mousemove", h);
                }),
      ...
      onDrag: function (a) {
        this.update({ start: this.start + a, end: this.end + a });
      },
    ...
    (a.initRegions = function () {
      this.regions ||
        ((this.regions = Object.create(a.Regions)), this.regions.init(this));
    }),
