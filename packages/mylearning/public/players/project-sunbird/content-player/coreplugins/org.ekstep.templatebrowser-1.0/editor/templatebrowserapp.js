...
angular
  .module("org.ekstep.templatebroser-1.0", [])
  .controller("templatebrowser", [
    ...
    function ($scope, $injector, instance) {
      ...
      ctrl.templateSelected = function (identifier, index) {
        ...
        if (!_.isUndefined(ctrl.lastSelected))
          ctrl.template[ctrl.lastSelected] = false;
      ...
      ctrl.save = function () {
        ...
        if (!_.isUndefined(ctrl.lastSelected))
          instance.callback && instance.callback(templateData);
        ctrl.closeWindow();
      };
    },
  ]);
