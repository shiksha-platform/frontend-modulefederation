angular
  ...
  .controller("lessonController", [
    ...
    function ($scope, $timeout, instance, callback, callerFilters) {
      ...
      $scope.contentMeta = ecEditor
        .getService("content")
        .getContentMeta($scope.contentId);
      ...
      $scope.showCardDetails = function (lesson) {
        ...
        ctrl.generateImpression({
          id: "button",
          type: "view",
          subtype: "view-details",
          pageid: "lessonbrowserplugin",
          duration: new Date() - $scope.startLoadTime,
        });
      };
      ...
      $scope.resetFilters = function () {
        ...
        $scope.$safeApply();
        $(
          ".filterMetaDetails .ui.dropdown",
          "#resourceFilterTemplate"
        ).dropdown("clear");
        ctrl.searchLessons(function (res) {
          ctrl.applyAllJquery();
          $scope.isCardSearching = false;
      ...
      ctrl.setFilterValues = function () {
        ...
        setTimeout(function () {
          ecEditor.dispatchEvent("org.ekstep.editcontentmeta:showpopup", {
            ...
            framework:
              ecEditor.getContext("resource_framework") ||
              ecEditor.getContext("framework"),
          ...
          ctrl.generateImpression({
            ...
            subtype: "popup-open",
            pageid: "lessonbrowserplugin",
            duration: new Date() - instance.startLoadTime,
          });
        }, 800);
      };
      ...
      $scope.viewAll = function (query, sectionIndex) {
        ...
        query.request.filters = _.mergeWith(
        ...
        ecEditor._.forEach(query.request.filters, function (value, key) {
          if (value && value.length) {
            $scope.filterSelection[key] = _.isString(value)
              ? value.split(",") || []
              : value;
          }
        });
