describe("lesson browser plugin", function () {
  ...
  beforeAll(function (done) {
    manifest = org.ekstep.pluginframework.pluginManager.getPluginManifest(
      "org.ekstep.lessonbrowser"
    );
    path = ecEditor.resolvePluginResource(
      manifest.id,
      manifest.ver,
      "editor/lessonBrowserApp.js"
    );
    pluginInstance =
      org.ekstep.pluginframework.pluginManager.pluginObjs[
        "org.ekstep.lessonbrowser"
      ];
          ...
          sections: [
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"contentType":["Resource"]},"limit":"10","sort_by":{"lastUpdatedOn":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"filters":{"contentType":["Resource"]},"sort_by":{"me_totalDownloads":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"mimeType":"application/vnd.ekstep.content-collection","contentType":"Collection"},"limit":10,"exists":["lastUpdatedOn"],"sort_by":{"lastUpdatedOn":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"mimeType":"application/vnd.ekstep.content-collection","contentType":"Collection"},"limit":10,"sort_by":{"me_totalDownloads":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"mimeType":"application/vnd.ekstep.ecml-archive","contentType":"Collection"},"limit":10,"sort_by":{"me_totalDownloads":"desc","me_totalInteractions":"desc"}}}',
            ...
            {
              display:
                '{"name":{"en":"Most Downloaded Interactive Worksheet"}}',
              alt: null,
              count: 0,
              description: null,
              index: 1,
              ...
              contents: null,
              searchQuery:
                '{"request":{"filters":{"mimeType":"application/vnd.ekstep.ecml-archive","contentType":["Resource"],"resourceType":["Worksheet"]},"limit":10,"sort_by":{"me_totalDownloads":"desc","me_totalInteractions":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"objectType":"Content","mimeType":"video/x-youtube"},"limit":10,"sort_by":{"me_totalDownloads":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"objectType":"Content","mimeType":"application/pdf"},"limit":10,"sort_by":{"me_totalDownloads":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"objectType":"Content","mimeType":"application/epub"},"limit":10,"sort_by":{"me_totalDownloads":"desc"}}}',
            ...
            },
            {
              ...
              contents: null,
              searchQuery:
                '{"request":{"query":"","filters":{"objectType":"Content","mimeType":"application/vnd.ekstep.h5p-archive"},"limit":10,"sort_by":{"me_totalDownloads":"desc"}}}',
    ...
    ecEditor.getService("meta").getPageAssemble = jasmine
      .createSpy()
  ...
  it("mock controller", function (done) {
    ...
    inject(function ($ocLazyLoad, _$rootScope_, _$controller_, _$timeout_) {
      ...
      $ocLazyLoad.load([{ type: "js", path: path }]).then(
        function () {
          ctrl = $controller("lessonController", {
            $scope: $scope,
  ...
  describe("Lesson browser", function () {
    ...
    describe("Search Concept", function () {
      it("Search concept should have been called", function () {
        ...
        searchService.search = jasmine
          .createSpy()
          .and.callFake(function (data, callback) {
            return callback(undefined, {
              data: {
                result: { concepts: [{ identifier: "c1", name: "Concpet1" }] },
              },
            });
          });
      ...
      it("Search lesson should have been called", function () {
        ...
        searchService.search = jasmine
          ...
          .and.callFake(function (data, callback) {
            return callback(undefined, {
              data: {
                result: { contents: [{ identifier: "L1", name: "lesson1" }] },
              },
            });
          });
    ...
    describe("Telemetry Generation", function () {
      it("should generate telemetry for user interaction", function () {
        ...
        var data = {
          ...
          type: "view-resource",
          subtype: "popup-open",
          pageid: "lessonbrowserplugin",
          uri: "http://localhost:9876/context.html",
          visits: [
            Object({
              objid: "do_1126972437930229761372",
              objtype: "Collection",
              section: "LessonBrowser",
              index: 0,
            }),
          ],
          duration: "5371271",
