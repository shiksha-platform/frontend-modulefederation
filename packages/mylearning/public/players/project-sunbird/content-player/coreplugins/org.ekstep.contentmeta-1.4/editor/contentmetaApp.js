  ...
  function ($scope, $timeout) {
    ...
    $scope.setActiveNode = function (data) {
      if (data.nodeId) {
        var activeNode = org.ekstep.services.collectionService.getActiveNode();
        activeNode
          ? org.ekstep.services.collectionService
              .getActiveNode()
              .setActive(false)
          : "";
        ...
        ecEditor.dispatchEvent("org.ekstep.collectioneditor:node:selected", {
          data: data,
        });
        ...
        function () {
          if ($scope.content) {
            ...
            if (
              ...
              ((activeNode && activeNode.data.root) ||
                $scope.content.visibility != "Default")
            ) {
              $scope.updateNode();
            }
          }
    ...
    ecEditor.addEventListener(
      "org.ekstep.contenteditor:after-save",
      $scope.updateRootNode,
      $scope
    );
