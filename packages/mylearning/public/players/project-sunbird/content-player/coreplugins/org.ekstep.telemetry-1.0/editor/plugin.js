org.ekstep.contenteditor.basePlugin.extend({
  ...
  registerEvents: function () {
    ...
    ecEditor.addEventListener(
      ...
      function (event, data) {
        if (data && data.id && data.id != "") {
          ...
          instance.service.pluginLifeCycle({
            type: "remove",
            pluginid: plugin.manifest.id,
            pluginver: plugin.manifest.ver,
            objectid: plugin.id,
            assetid: plugin.getAttribute("asset"),
    ...
    ecEditor.addEventListener(
      "plugin:add",
      function (event, data) {
        var stageId = ecEditor.getCurrentStage()
    ...
    ecEditor.addEventListener(
      ...
      function (event, data) {
        ...
        instance.service.error({
          ...
          object: object,
          plugin: { id: data.plugin, ver: data.version, category: "" },
        });
      },
      this
    );
