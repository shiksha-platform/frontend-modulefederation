  ...
  describe("initialize ckeditor", function () {
    ...
    it("should create ck-editor instance and checks rtl support implementation for urdu input", function (done) {
      ckEditorInstance.on("instanceReady", function (event) {
        ...
        inputTextAsElement = new DOMParser().parseFromString(
          inputText,
          "text/html"
    ...
    it("should create ck-editor instance and applies font size and cheks changes in ck-editor text", function (done) {
      ckEditorInstance.on("instanceReady", function (event) {
        ...
        var fontSelectionToolBarElem = document.getElementsByClassName(
          "cke_combo__fontsize"
        )[0];
        ...
        setTimeout(function () {
          // Async Tick which will ensure < Iframe for font size  Dropdown > to be created before interacting with it
          var comboBoxFrame = document
            .getElementsByClassName("cke_combopanel")[0]
            .getElementsByTagName("iframe")[0]; // comboBox is a seperate iframe
          var comboBoxContainer =
            comboBoxFrame.contentWindow.document.getElementsByTagName("ul")[0];
          ...
          var actualFontSize =
            inputTextAsElement.getElementsByTagName("span")[0].style.fontSize;
