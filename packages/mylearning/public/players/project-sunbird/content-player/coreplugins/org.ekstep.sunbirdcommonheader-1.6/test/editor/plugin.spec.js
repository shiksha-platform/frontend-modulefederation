    ...
    it("Should invoke updateOwnershipList method to update content owner list", function (done) {
      var data = {
        data: {
          ...
          id: "do_2125627634838978561365",
          root: false,
          metadata: {
            keywords: ["games", "hsxghzgxhzxgc", "colors"],
            subject: "Tamil",
            channel: "012315809814749184151",
            downloadUrl:
              "https://ekstep-public-qa.s3-ap-south-1.amazonaws.com/ecar_files/do_2125627634838978561365/course-qa_1533541131212_do_2125627634838978561365_2.0_spine.ecar",
            organisation: ["Consumption Org", "ORG25"],
            language: ["English"],
            mimeType: "application/vnd.ekstep.content-collection",
            objectType: "Content",
            gradeLevel: ["Class 2"],
            children: ["do_2125614164736901121137"],
            collections: [
              "do_2126023386662092801121",
              "do_2126023386662010881120",
            ],
            identifier: "do_2125627634838978561365",
