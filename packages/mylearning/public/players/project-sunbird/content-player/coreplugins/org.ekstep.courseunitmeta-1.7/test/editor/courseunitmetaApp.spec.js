describe("Ekstep Unitmeta Plugin:", function () {
  ...
  var instance = {
    manifest: { id: "org.ekstep.courseunitmeta", ver: "1.7" },
    data: "",
  };
  ...
  describe("Unitmeta plugin test cases", function () {
    ...
    it("Should invoke onNodeSelect method", function (done) {
      ...
      $scope.unit = {
        identifier: "do_112582700816465920118",
        code: "do_112582700816465920118",
        visibility: "Parent",
        topicData: "(4) topics selected",
        topics: ["Topic 1", "Topic 2", "Topic 1 child", "Topic 3"],
        index: 1,
        mimeType: "application/vnd.ekstep.content-collection",
        createdOn: "2018-09-03T11:30:20.760+0000",
        conceptData: "(1) concepts selected",
        versionKey: "1535974220760",
        concepts: [
          {
            identifier: "AI31",
        ...
        lastUpdatedOn: "2018-09-04T11:32:48.001+0000",
        contentType: "TextBookUnit",
        status: "Draft",
      };
      var data = {
        data: {
          id: "do_112582700816465920118",
    ...
    it("Should invoke generateTelemetry  method", function (done) {
      var data = {
        ...
        pluginver: "1.2",
        objectid: "do_112582700816465920118",
        stage: "stage",
      };
