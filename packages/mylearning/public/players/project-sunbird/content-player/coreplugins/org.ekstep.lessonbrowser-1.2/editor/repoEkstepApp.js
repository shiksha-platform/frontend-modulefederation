  ...
  .controller("contentproviderekstepController", [
    ...
    function ($scope, $timeout) {
      ...
      $scope.getFiltersValue = function () {
        ...
        $scope.filterSelection.lang = $("#lessonBrowser_language").dropdown(
          "get value"
        );
        $scope.filterSelection.grade = $("#lessonBrowser_grade").dropdown(
          "get value"
        );
        $scope.filterSelection.lessonType = $(
          "#lessonBrowser_lessonType"
        ).dropdown("get value");
        $scope.filterSelection.subject = $("#lessonBrowser_subject").dropdown(
          "get value"
        );
      ...
      setTimeout(function () {
        $("#lessonBrowser_language").dropdown(
          "set selected",
          $scope.filterSelection.lang
        );
        $("#lessonBrowser_grade").dropdown(
          "set selected",
          $scope.filterSelection.grade
        );
        $("#lessonBrowser_lessonType").dropdown(
        ...
        $("#lessonBrowser_subject").dropdown(
          "set selected",
          $scope.filterSelection.subject
        );
        $scope.applyFilters();
