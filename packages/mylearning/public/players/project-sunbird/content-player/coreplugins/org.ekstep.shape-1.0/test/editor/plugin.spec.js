...
describe("Shape plugin", function () {
  ...
  describe("should create all shapes", function () {
    it("should create rectangle and test circle configuration changes", function () {
      ...
      // Test Rectangle
      ecEditor.dispatchEvent("org.ekstep.shape:create", {
        type: "rect",
        x: 10,
        y: 20,
        fill: "#FFFF00",
      ...
      var fbObject = ContentEditorTestFramework.getFabricObject(
        rect.id,
        ecEditor.getCanvas()
      );
      ...
      ContentEditorTestFramework.validateObject(rect.toECML(), {
        ...
        id: rect.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FFFF00"}',
      });
      ...
      ContentEditorTestFramework.validateObject(rect.toECML(), {
        ...
        id: rect.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#CC1234"}',
      });
    ...
    it("should create circle and test circle configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(circle.toECML(), {
        ...
        id: circle.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#00FF00","radius":64.8}',
      });
      ...
      ContentEditorTestFramework.validateObject(circle.toECML(), {
        ...
        id: circle.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#00FF00","radius":20}',
      });
    });
    ...
    it("should create rounded rectange and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(roundedRect.toECML(), {
        ...
        id: roundedRect.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","radius":10}',
      });
      ...
      ContentEditorTestFramework.validateObject(roundedRect.toECML(), {
        ...
        id: roundedRect.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","radius":20}',
      });
    ...
    it("should create star shape and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(star.toECML(), {
        ...
        id: star.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","corners":5,"points":[{"x":50,"y":0},{"x":60.9,"y":35},{"x":100,"y":35},{"x":67.6,"y":60},{"x":79.4,"y":100},{"x":50,"y":72},{"x":20.6,"y":100},{"x":32.4,"y":60},{"x":0,"y":35},{"x":39.1,"y":35}]}',
      });
      ...
      ContentEditorTestFramework.validateObject(star.toECML(), {
        ...
        id: star.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","corners":6,"points":[{"x":50,"y":100},{"x":35,"y":76},{"x":0,"y":75},{"x":20,"y":50},{"x":0,"y":25},{"x":35,"y":24},{"x":50,"y":0},{"x":65,"y":24},{"x":100,"y":25},{"x":80,"y":50},{"x":100,"y":75},{"x":65,"y":76}]}',
      });
    });
    ...
    it("should create polygon shape and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(polygon.toECML(), {
        ...
        id: polygon.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","sides":5,"points":[{"x":50,"y":0},{"x":100,"y":34.5},{"x":79.4,"y":100},{"x":20.6,"y":100},{"x":0,"y":34.5}]}',
      });
      ...
      ContentEditorTestFramework.validateObject(polygon.toECML(), {
        ...
        id: polygon.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","sides":6,"points":[{"x":100,"y":50},{"x":75,"y":100},{"x":25,"y":100},{"x":0,"y":50},{"x":25,"y":0},{"x":75,"y":0}]}',
      });
    });
    ...
    it("should create trapezium shape and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(trapezium.toECML(), {
        ...
        id: trapezium.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","points":[{"x":25,"y":0},{"x":75,"y":0},{"x":100,"y":100},{"x":0,"y":100}]}',
      });
    });
    ...
    it("should create single arrow shape and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(arrow.toECML(), {
        ...
        id: arrow.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#000000","points":[{"x":0,"y":25},{"x":75,"y":25},{"x":75,"y":0},{"x":100,"y":50},{"x":75,"y":100},{"x":75,"y":75},{"x":0,"y":75}]}',
      });
    });
    ...
    it("should create double arrow shape and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(doubleArrow.toECML(), {
        ...
        id: doubleArrow.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#000000","points":[{"x":0,"y":50},{"x":25,"y":0},{"x":25,"y":25},{"x":75,"y":25},{"x":75,"y":0},{"x":100,"y":50},{"x":75,"y":100},{"x":75,"y":75},{"x":25,"y":75},{"x":25,"y":100}]}',
      });
    });
    ...
    it("should create triangle and test configuration changes", function () {
      ...
      ContentEditorTestFramework.validateObject(triangle.toECML(), {
        ...
        id: triangle.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#FF0000","sides":3,"points":[{"x":50,"y":0},{"x":100,"y":100},{"x":0,"y":100}]}',
      });
      ...
      ContentEditorTestFramework.validateObject(triangle.toECML(), {
        ...
        id: triangle.id,
        "config.__cdata":
          '{"opacity":100,"strokeWidth":1,"stroke":"rgba(255, 255, 255, 0)","autoplay":false,"visible":true,"color":"#CC1234","sides":3,"points":[{"x":50,"y":0},{"x":100,"y":100},{"x":0,"y":100}]}',
      });
    });
  });
});
