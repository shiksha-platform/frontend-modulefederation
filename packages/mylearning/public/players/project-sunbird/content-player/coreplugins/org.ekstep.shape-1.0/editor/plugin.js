...
org.ekstep.contenteditor.basePlugin.extend({
  ...
  newInstance: function () {
    ...
    switch (this.attributes.type) {
      ...
      case "rect":
        ...
        if (props.subtype !== "slidebackground")
          this.editorObj = new fabric.Rect(props);
        break;
  ...
  changed: function (instance, options, event) {
    if (instance.attributes.type == "roundrect") {
      instance.editorObj.setWidth(
        instance.editorObj.getWidth() - instance.editorObj.getStrokeWidth()
      );
      instance.editorObj.setHeight(
        instance.editorObj.getHeight() - instance.editorObj.getStrokeWidth()
      );
