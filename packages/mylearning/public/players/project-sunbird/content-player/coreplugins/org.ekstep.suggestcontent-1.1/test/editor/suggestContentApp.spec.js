describe("Ekstep SuggestContent Plugin:", function () {
  ...
  describe("Asset suggestcontent plugin test cases", function () {
    ...
    it("Should invoke addContent method", function () {
      ecEditor.jQuery("#collection-tree").fancytree("getTree").activeNode =
        ecEditor.jQuery("#collection-tree").fancytree("getTree").rootNode;
      var lesson = {
        subject: "Mathematics",
        channel: "b00bc992ef25f1a9a8d63291e20efc8d",
        downloadUrl:
          "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/ecar_files/do_112485066089308160127/col-test-1_1524056181839_do_112485066089308160127_1.0_spine.ecar",
        language: ["English"],
        ...
        appIcon:
          "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_112485066089308160127/artifact/1_1466405046949.thumb.jpg",
        children: [],
        appId: "dev.sunbird.portal",
        contentEncoding: "gzip",
        mimeTypesCount:
          '{"application/vnd.ekstep.h5p-archive":1,"application/vnd.ekstep.content-collection":16}',
        contentType: "Collection",
        identifier: "do_112485066089308160127",
        lastUpdatedBy: "3b34c469-460b-4c20-8756-c5fce2de9e69",
        audience: ["Learner"],
        visibility: "Default",
        toc_url:
          "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_112485066089308160127/artifact/do_112485066089308160127toc.json",
        contentTypesCount: '{"Collection":16,"Story":1}',
        consumerId: "72e54829-6402-4cf0-888e-9b30733c1b88",
        childNodes: [
          "do_112485066593263616130",
          "do_112485066593280000137",
          "do_112485066593263616129",
          "do_112485066593271808134",
          "do_112485066593280000136",
          "do_112485066593280000138",
          "do_112485066593271808131",
          "do_112485066593271808133",
          "do_112485066593280000135",
          "do_112485066593271808132",
          "do_112485066593296384142",
          "do_112485066593288192139",
          "do_112485066593296384144",
          "do_112485066593296384143",
          "do_112473631695626240110",
          "do_112485066593288192141",
          "do_112485066593288192140",
        ],
        mediaType: "content",
        ...
        prevState: "Review",
        size: 290323,
        lastPublishedOn: "2018-04-18T12:56:21.796+0000",
        IL_FUNC_OBJECT_TYPE: "Content",
        name: "col test 1",
        status: "Live",
        code: "do_112485066089308160127",
        medium: "English",
        idealScreenSize: "normal",
        posterImage:
          "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/1_1466405046949.jpg",
        createdOn: "2018-04-18T12:51:59.104+0000",
        contentDisposition: "inline",
        lastUpdatedOn: "2018-04-18T12:56:16.768+0000",
        SYS_INTERNAL_LAST_UPDATED_ON: "2018-04-18T12:56:22.487+0000",
        createdFor: ["ORG_001"],
        creator: "N. T. RAO . creator_org_001",
        IL_SYS_NODE_TYPE: "DATA_NODE",
        os: ["All"],
        pkgVersion: 1,
        versionKey: "1524056176768",
        idealScreenDensity: "hdpi",
        framework: "NCF",
        s3Key:
          "ecar_files/do_112485066089308160127/col-test-1_1524056181839_do_112485066089308160127_1.0_spine.ecar",
        lastSubmittedOn: "2018-04-18T12:53:32.976+0000",
        createdBy: "6d4da241-a31b-4041-bbdb-dd3a898b3f85",
        compatibilityLevel: 4,
        leafNodesCount: 1,
        IL_UNIQUE_ID: "do_112485066089308160127",
        board: "NCERT",
    ...
    it("Should invoke refreshSuggestions method", function () {
      ...
      ecEditor.jQuery("#collection-tree").fancytree("getTree").activeNode =
        ecEditor
          ...
          .fancytree("getTree").rootNode.children[0];
    ...
    it("Should invoke searchLessons method", function () {
      ...
      var resp = {
        data: {
          ...
          ver: "3.0",
          ts: "2018-09-14T12:32:46ZZ",
          params: {
            resmsgid: "92ad3749-d9e9-4a38-a579-1316c8fa36ef",
            msgid: null,
            err: null,
            status: "successful",
            errmsg: null,
          ...
          result: {
            ...
            content: [
              {
                code: "org.sunbird.zLZQxw",
                subject: "Marathi",
                channel: "in.ekstep",
                description: "गवताचं पातं",
                language: ["Marathi"],
                mimeType: "video/x-youtube",
                medium: "Marathi",
                idealScreenSize: "normal",
                createdOn: "2017-09-01T13:07:22.593+0000",
                objectType: "Content",
                appIcon:
                  "https://ekstep-public-qa.s3-ap-south-1.amazonaws.com/content/do_2123031620002938881144/artifact/cat-picture-free-download-9_1501850830651.jpg",
                gradeLevel: ["Class 2"],
                contentDisposition: "online",
                artifactUrl:
                  "https://www.youtube.com/embed/1832_170506143105.mp3?autoplay=1&enablejsapi=1",
                contentEncoding: "identity",
                lastUpdatedOn: "2017-09-04T13:22:06.806+0000",
                contentType: "Resource",
                lastUpdatedBy: "98e09d6e-b95b-4832-bfab-421e63d36aa7",
                identifier: "do_2123229900193218561711",
                audience: ["Learner"],
                os: ["All"],
                visibility: "Default",
                consumerId: "fa271a76-c15a-4aa1-adff-31dd04682a1f",
                author: "PRAVIN DAKARE",
                mediaType: "content",
                osId: "org.ekstep.quiz.app",
                ageGroup: ["Other"],
                languageCode: "mr",
      ...
      $scope.responseData = [];
      spyOn(
        org.ekstep.contenteditor.api.getService("search"),
        "search"
      ).and.callFake(function (searchBody, cb) {
        cb(false, resp);
      });
      $scope.responseData["topics"] = ["topic1", "topic2", "topic3"];
