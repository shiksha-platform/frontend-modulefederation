...
var youtubeSample = {
  ...
  config: {
    __cdata:
      '{"autoplay":true,"controls":false,"muted":false,"visible":true,"url":"https://www.youtube.com/watch?v=D8m7jsLi7hs"}',
  },
  pluginType: "org.ekstep.video",
  font: "NotoSans, NotoSansGujarati, NotoSansOriya, NotoSansMalayalam",
  _id: "48d8dcd4-3c1c-4847-b5cd-c1ea464b7bd0",
  asset: "48d8dcd4-3c1c-4847-b5cd-c1ea464b7bd0",
  videoPlayer: {
    techOrder: ["youtube"],
    html5: {},
    flash: {},
    ...
    tracks: [],
    style:
      "width: 279.475px; height: 159.408px; position: absolute; left: 158.515px; top: 56.7972px;",
    id: "48d8dcd4-3c1c-4847-b5cd-c1ea464b7bd0",
    class: "video-js vjs-default-skin",
    preload: "auto",
    autoplay: true,
    controlslist: "nodownload",
    controls: true,
    src: "https://www.youtube.com/watch?v=D8m7jsLi7hs",
    initChildren: false,
    createEl: false,
...
var driveSample = {
  ...
  config: {
    __cdata:
      '{"autoplay":true,"controls":false,"muted":false,"visible":true,"url":"https://drive.google.com/uc?export=download&id=1Lpw4ayeqTtRDTAjnGlaImLIikwh33ziC"}',
  },
  pluginType: "org.ekstep.video",
  font: "NotoSans, NotoSansGujarati, NotoSansOriya, NotoSansMalayalam",
  _id: "5aae73d8-23e4-4de3-b35e-417b1d753606",
  asset: "5aae73d8-23e4-4de3-b35e-417b1d753606",
  controls: false,
  muted: false,
  autoplay: true,
  id: "5aae73d8-23e4-4de3-b35e-417b1d753606",
};
...
describe("Video plugin", function () {
  ...
  describe("Render Plugin with Drive/Youtube Video", function () {
    ...
    it("Events must be registred", function (done) {
      expect(EkstepRendererAPI.hasEventListener("actionNavigateNext")).toBe(
        true
      );
      expect(EkstepRendererAPI.hasEventListener("actionNavigatePrevious")).toBe(
        true
      );
