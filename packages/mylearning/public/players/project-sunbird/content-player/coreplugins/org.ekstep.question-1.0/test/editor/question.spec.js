describe("EditorPlugin", function () {
  ...
  beforeEach(function (done) {
    ...
    plugin.manifest = {
      id: "org.ekstep.question",
      ver: "1.0",
      author: "Jagadish",
      title: "Question Plugin",
      description: "Plugin to create questions",
      editor: {
        main: "editor/plugin.js",
        dependencies: [
          { type: "css", src: "editor/style.css" },
          { type: "js", src: "editor/question.js" },
          { type: "plugin", plugin: "org.ekstep.questionunit.mcq", ver: "1.0" },
          { type: "plugin", plugin: "org.ekstep.questionunit.ftb", ver: "1.0" },
          {
            type: "plugin",
            plugin: "org.ekstep.questionset.preview",
            ver: "1.0",
          },
          { type: "plugin", plugin: "org.ekstep.questionunit.mtf", ver: "1.0" },
          { type: "plugin", plugin: "org.ekstep.sunbirdmetadata", ver: "1.0" },
        ],
        menu: [],
        "init-data": {},
        configManifest: [{}],
    ...
    assessmentService = jasmine.createSpyObj("assessment", [
      "saveQuestionV3",
      "getQuestionunitPlugins",
    ]);
    ...
    mcqPlugin = {
      ...
      editor: {
        main: "editor/plugin.js",
        dependencies: [
          { type: "plugin", plugin: "org.ekstep.questionunit", ver: "1.0" },
          { type: "css", src: "editor/styles/style.css" },
        ],
        menu: [],
        "init-data": {
          type: "rect",
      ...
      renderer: {
        main: "renderer/plugin.js",
        dependencies: [
          { type: "css", src: "renderer/styles/style.css" },
          { type: "js", src: "renderer/util/evaluator.js" },
          { type: "js", src: "renderer/controllers/horizontal_controller.js" },
          { type: "js", src: "renderer/templates/horizontal_template.html" },
        ],
      },
      dependencies: [
        {
      ...
      templates: [
        {
          ...
          renderer: {
            template: "renderer/templates/mtf_template.html",
            controller: "renderer/controllers/mtf_controller.js",
          },
        },
      ],
      renderer: {
        ...
        dependencies: [
          { type: "css", src: "renderer/styles/style.css" },
          { type: "js", src: "renderer/util/evaluator.js" },
          { type: "js", src: "renderer/controllers/mtf_controller.js" },
          { type: "js", src: "renderer/templates/mtf_template.html" },
        ],
      },
      dependencies: [
        {
      ...
      templates: [
        {
          ...
          ver: "1.0",
          thumbnail1:
            "/plugins/org.ekstep.questionunit.ftb-1.0/editor/assets/ftb-horizontal.png",
          data: {
    ...
    spyOn(
      org.ekstep.pluginframework.pluginManager,
      "getPluginManifest"
    ).and.callFake(function (pluginId) {
      if (pluginId === "org.ekstep.question") {
        return plugin.manifest;
      } else if (pluginId === "org.ekstep.questionunit.mcq") {
        return mcqPlugin;
  ...
  describe("Question Creation", function () {
    var value = {},
      ...
      validFormEvent;
    beforeEach(function () {
      ctrl = $controller("QuestionCreationFormController", {
        $scope: $scope,
        instance: plugin,
        questionData: {},
      });
      ...
      value = {
        ...
        ver: "1.0",
        thumbnail1:
          "/plugins/org.ekstep.questionunit.mcq-1.0/editor/assets/mcq-horizontal.png",
      ...
      metaDataObj = {
        isValid: true,
        formData: { metaData: {}, nodeId: "do_112495621900836864142" },
      };
      ...
      window.context = {
        ...
        user: {
          ...
          avtar:
            "https://release.ekstep.in/media/com_easysocial/defaults/avatars/user/medium.png",
          logout:
            "https://release.ekstep.in/index.php?option=com_easysocial&view=login&layout=logout",
        },
        baseURL: "https://release.ekstep.in/",
        editMetaLink: "/component/ekcontent/contentform/do_10097535?Itemid=0",
        contentId: "do_112467889506631680131",
        uid: "390",
        etags: { app: [], partner: [], dims: [] },
        pdata: { id: "in.ekstep", ver: "1.0", pid: "contenteditor" },
      };
                      ...
                      "org.ekstep.question": [
                        {
                          ...
                          data: '{"question":{"text":"<p>Match the color</p>\\n","image":"","audio":"","hint":""},"option":{"optionsLHS":[{"text":"Apple","image":"","audio":"","hint":"","index":1,"$$hashKey":"object:903"},{"text":"Sky","image":"","audio":"","hint":"","index":2,"$$hashKey":"object:904"},{"text":"Leaf","image":"","audio":"","hint":"","index":3,"$$hashKey":"object:905"}],"optionsRHS":[{"text":"Red","image":"","audio":"","hint":"","mapIndex":1},{"text":"blue","image":"","audio":"","hint":"","mapIndex":2},{"text":"Green","image":"","audio":"","hint":"","mapIndex":3}],"questionCount":0},"media":[],"questionCount":1}',
                          config:
                            '{"metadata":{"title":"question title","description":"question description","medium":"English"},"max_time":0,"max_score":1,"partial_scoring":true,"isShuffleOption":false,"layout":"Horizontal"}',
                          w: "80",
                          x: "9",
                          h: "85",
                          y: "6",
                    ...
                    [
                      {
                        ...
                        plugin: "org.ekstep.questionunit",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit-1.0/renderer/plugin.js",
                        type: "plugin",
                      },
                      {
                        ...
                        plugin: "org.ekstep.questionunit",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit-1.0/manifest.json",
                        type: "json",
                      },
                      {
                        id: "7dec3d7d-ebc7-4133-b147-d442003574bb",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/renderer/styles/style.css",
                        type: "css",
                      },
                      {
                        id: "2541beec-c56c-4a26-9967-cebde76a7511",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/renderer/util/evaluator.js",
                        type: "js",
                      },
                      {
                        id: "002e2e62-594c-41a6-a9c6-4d07255cc086",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/renderer/controllers/mtf_controller.js",
                        type: "js",
                      },
                      {
                        id: "052873b7-104a-45bb-890e-0364d95d2be0",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/renderer/templates/mtf_template.html",
                        type: "js",
                      },
                      {
                        id: "org.ekstep.questionunit.mtf",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/renderer/plugin.js",
                        type: "plugin",
                      },
                      {
                        id: "org.ekstep.questionunit.mtf_manifest",
                        plugin: "org.ekstep.questionunit.mtf",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionunit.mtf-1.0/manifest.json",
                        type: "json",
                      },
                      {
                        id: "624ca773-1624-4699-a6c1-014e633a6d90",
                        plugin: "org.ekstep.navigation",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.navigation-1.0/renderer/controller/navigation_$scope.js",
                        type: "js",
                      },
                      {
                        id: "3a54b744-2193-4804-8854-51e9c8de2151",
                        plugin: "org.ekstep.navigation",
                        ver: "1.0",
                      ...
                      },
                      {
                        ...
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset.quiz-1.0/renderer/plugin.js",
                        type: "plugin",
                      },
                      {
                        ...
                        plugin: "org.ekstep.questionset.quiz",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset.quiz-1.0/manifest.json",
                        type: "json",
                      },
                      {
                      ...
                      {
                        id: "1d25869b-6b9a-4912-89c2-a8809a83eb1b",
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/renderer/controller/questionset_$scope.js",
                        type: "js",
                      },
                      {
                        id: "a4154b0a-9875-4d61-b2d0-ebe85ec46621",
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/renderer/templates/questionset_template.html",
                        type: "js",
                      },
                      {
                        id: "5468edbd-c1dc-4640-93b8-9ec193452833",
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/renderer/utils/telemetry_logger.js",
                        type: "js",
                      },
                      {
                        id: "13ebeec2-2aec-4038-a306-7e3c6ba9621a",
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/renderer/styles/style.css",
                        type: "css",
                      },
                      {
                        ...
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/renderer/plugin.js",
                        type: "plugin",
                      },
                      {
                        ...
                        plugin: "org.ekstep.questionset",
                        ver: "1.0",
                        src: "/plugins/org.ekstep.questionset-1.0/manifest.json",
                        type: "json",
                      },
                    ],
                  ],
                ...
                "plugin-manifest": {
                  plugin: [
                    ...
                    },
                    {
                      ...
                      type: "plugin",
                      depends:
                        "org.ekstep.questionset.quiz,org.ekstep.iterator",
                    },
                  ],
                },
              },
      ...
      validFormData = {
        question: {
          text: "<p>choose the color of the sky</p>\n",
          image: "",
          audio: "",
          hint: "",
        },
    ...
    describe("showQuestionUnitForm function", function () {
      it("should add templateName as Multiple Choice Question", function () {
        ...
        expect($scope.questionUnitTemplateURL).toEqual(
          "/plugins/org.ekstep.questionunit.mcq-1.0/editor/templates/horizontal_template.html?BUILDNUMBER"
        );
      });
      it("should set category as other if it doesnot contain category", function () {
        $scope.showQuestionUnitForm(value);
        expect(ecEditor.resolvePluginResource).toHaveBeenCalledWith(
          value.pluginID,
          value.ver,
          value.editor.templateURL
        );
      });
    });
    describe("saveMetaData function", function () {
      it("should call saveQuestion while storing the meta data", function () {
        $scope.questionCreationFormData = {
          question: {
            text: "<p>choose the color of the sky</p>\n",
            image: "",
            audio: "",
      ...
      it("should set metaData if it is FTB question", function () {
        $scope.questionCreationFormData = {
          question: {
            text: "<p>The color of sky is [[blue]]</p>\n",
            image: "",
            audio: "",
          ...
          answer: ["blue"],
          parsedQuestion: {
            text: '<p>The color of sky is <input type="text" class="ans-field" id="ans-field1"></p>\n',
            image: "",
            audio: "",
          },
        };
      ...
      it("should set metaData if it is MTF question", function () {
        $scope.questionCreationFormData = {
          ...
          option: {
            ...
            optionsRHS: [
              { text: "Red", image: "", audio: "", hint: "", mapIndex: 1 },
              { text: "blue", image: "", audio: "", hint: "", mapIndex: 2 },
              { text: "Green", image: "", audio: "", hint: "", mapIndex: 3 },
            ],
            questionCount: 0,
          },
          media: [],
        ...
        $scope.questionMetaData = {
          ...
          gradeLevel: ["Kindergarten"],
          concepts: [
            { identifier: "LO4", name: "Understanding of Grammar/Syntax" },
          ],
        };
        $scope.category = "MTF";
        $scope.saveMetaData(metaDataEvent, metaDataObj);
    ...
    describe("setPreviewData function", function () {
      beforeEach(function () {
        $scope.questionCreationFormData = {
          question: {
            text: "<p>Choose the color of sky</p>\n",
            image: "",
            audio: "",
            hint: "",
          },
          options: [
            { text: "blue", image: "", audio: "", hint: "", isCorrect: true },
            { text: "red", image: "", audio: "", hint: "", isCorrect: false },
          ],
          questionCount: 1,
          media: [],
        };
  ...
  describe("Question Edit on", function () {
    ...
    beforeEach(function () {
      questionData1 = {
        ...
        template: "NA",
        template_id: "NA",
        options: [{ answer: true, value: { type: "text", asset: "1" } }],
        identifier: "do_112495621900836864142",
        isSelected: true,
        $$hashKey: "object:2145",
      };
      ctrl = $controller("QuestionCreationFormController", {
    ...
    it("should call showQuestionForm", function () {
      var expectedQData = {
        ...
        qcLanguage: "English",
        questionTitle: "choose the color of the sky\n",
        qcLevel: "EASY",
        ...
        questionDesc: "choose the color of the sky",
        questionMaxScore: 1,
      };
      $scope.showQuestionForm(expectedQData);
      expect($scope.questionData.isShuffleOption).toEqual(
        expectedQData.isShuffleOption
      );
    });
    ...
    it("should go back to template screen", function () {
      ...
      $scope.back();
      expect($scope.questionData.questionMaxScore).toEqual(
        metaFormScope.contentMeta.max_score
      );
    });
    ...
    it("should call saveQuestionV3", function () {
      ...
      expect(
        ecEditor.getService("assessment").saveQuestionV3
      ).toHaveBeenCalled();
    });
  });
});
