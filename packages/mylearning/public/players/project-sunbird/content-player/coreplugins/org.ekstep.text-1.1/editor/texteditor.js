...
var textEditor = (function () {
  var $editor = ecEditor.jQuery("#authoringTextEditor"),
    ...
    $btnGrpParent = ecEditor.jQuery("<div>", {
      style: "margin-top: 6px; margin-right: 6px;",
    });
  $buttonGrp = ecEditor.jQuery("<div>", {
    class: "ui buttons",
    id: "texteditorBtnGrp",
    style: "float: right;",
  });
  $orBtn = ecEditor.jQuery("<div>", { class: "or" });
  (pluginId = undefined), (editorText = undefined);
