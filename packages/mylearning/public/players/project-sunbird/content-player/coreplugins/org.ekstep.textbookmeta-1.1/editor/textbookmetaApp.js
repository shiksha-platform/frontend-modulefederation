angular
  .module("textbookmetaApp", ["ngTokenField", "Scope.safeApply"])
      ...
      $scope.initDropdown = function () {
        $timeout(function () {
          $("#textbookmeta-board").dropdown(
            "set selected",
            $scope.textbook.board
          );
          $("#textbookmeta-medium").dropdown(
            "set selected",
            $scope.textbook.medium
          );
          $("#textbookmeta-subject").dropdown(
            "set selected",
            $scope.textbook.subject
          );
          $("#textbookmeta-gradeLevel").dropdown(
            "set selected",
            $scope.textbook.gradeLevel
          );
          $("#textbookmeta-audience").dropdown(
            "set selected",
            $scope.textbook.audience
          );
          $("#textbookmeta-language").dropdown(
            "set selected",
            $scope.textbook.language
          );
