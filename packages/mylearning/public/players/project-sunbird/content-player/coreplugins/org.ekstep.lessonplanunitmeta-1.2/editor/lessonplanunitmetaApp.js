angular
  .module("lessonplanunitmetaApp", [])
  .controller("lessonplanunitmetaController", [
    "$scope",
    function ($scope) {
      ...
      $scope.onNodeSelect = function (event, data) {
        ...
        if (
          ...
          _.has(activeNode.data.metadata, ["description"])
        ) {
      ...
      ecEditor.addEventListener(
        "org.ekstep.collectioneditor:node:selected:LessonPlanUnit",
        $scope.onNodeSelect
      );
