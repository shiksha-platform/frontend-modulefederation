  ...
  return (
      ...
      ajax: function (b) {
        ...
        return (
          ...
          d.addEventListener("progress", function (a) {
            c.fireEvent("progress", a),
              a.lengthComputable && a.loaded == a.total && (e = !0);
          }),
          d.addEventListener("load", function (a) {
            e || c.fireEvent("progress", a),
              c.fireEvent("load", a),
              200 == d.status || 206 == d.status
                ? c.fireEvent("success", d.response, a)
                : c.fireEvent("error", a);
          }),
    ...
    (a.WebAudio = {
      ...
      getAudioContext: function () {
        return (
          a.WebAudio.audioContext ||
            (a.WebAudio.audioContext = new (window.AudioContext ||
      ...
      getOfflineAudioContext: function (b) {
        return (
          a.WebAudio.offlineAudioContext ||
            (a.WebAudio.offlineAudioContext = new (window.OfflineAudioContext ||
              window.webkitOfflineAudioContext)(1, 2, b)),
          a.WebAudio.offlineAudioContext
        );
      },
      init: function (b) {
    ...
    a.util.extend(a.MediaElement, {
      ...
      getPeaks: function (b) {
        return this.buffer
          ? a.WebAudio.getPeaks.call(this, b)
          : this.peaks || [];
      },
      getVolume: function () {
    ...
    a.util.extend(a.Drawer.Canvas, {
      createElements: function () {
        ...
        if (
          ...
          var b = this.progressWave.appendChild(
    ...
    (function () {
      var b = function () {
        ...
        Array.prototype.forEach.call(b, function (b) {
          var c = a.util.extend(
            { container: b, backend: "MediaElement", mediaControls: !0 },
            b.dataset
          );
