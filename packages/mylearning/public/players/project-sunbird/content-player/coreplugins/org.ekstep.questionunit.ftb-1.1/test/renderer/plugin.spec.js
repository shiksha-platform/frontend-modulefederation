describe("RendererPlugin", function () {
  ...
  beforeEach(function () {
    ...
    plugin.saveQuestionState = jasmine
      .createSpy("saveQuestionState")
    ...
    plugin._question = {
      template:
        '<div id="ftb-template">  <div class="qs-ftb-container">    <div class="qs-ftb-content">        <div class="qs-ftb-question" id="qs-ftb-question">          <%= question.data.question.text %>        </div>    </div>  </div></div>',
      data: {
        question: {
  ...
  describe("setQuestionTemplate", function () {
    ...
    it("should call generateHTML", function () {
      plugin.preQuestionShow(showFTBEvent); // eslint-disable-line no-unused-vars
      expect(FTBController.generateHTML).toHaveBeenCalledWith(
        plugin._question.data
