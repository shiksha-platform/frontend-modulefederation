angular
  .module("org.ekstep.genericeditorsidebar", [])
  .controller("sidebarController", [
    "$scope",
    function ($scope) {
      $scope.sidebarTemplate = undefined;
      $scope.videoTemplate = ecEditor.resolvePluginResource(
        "org.ekstep.genericeditorsidebar",
        "1.0",
        "editor/partials/videoSidebarTemplate.html"
      );
      $scope.pdf_Epub_Template = ecEditor.resolvePluginResource(
        "org.ekstep.genericeditorsidebar",
        "1.0",
        "editor/partials/pdf_Epub_Template.html"
      );
      $scope.html_h5pTemplate = ecEditor.resolvePluginResource(
        "org.ekstep.genericeditorsidebar",
        "1.0",
        "editor/partials/html_h5pTemplate.html"
      );
