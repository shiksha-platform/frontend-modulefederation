describe("MTFRendererPlugin", function () {
  ...
  beforeAll(function (done) {
    ...
    target =
      '<div class="mtf-hori-ques-text-inner cont-dragula" id="left1" leftindex="1"><p class="gu-transit">z</p></div>';
    source =
      '<div class="mtf-hori-ques-text-inner cont-dragula" id="right1" mapindex="1">  </div>';
    si = null;
  ...
  describe("setQuestionTemplate", function () {
    it("should plugin will initialize", function () {
      expect(org.ekstep.pluginframework.pluginManager.plugins["mtf"]).not.toBe(
        undefined
      );
