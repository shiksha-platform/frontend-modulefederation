...
angular
  ...
  .controller("readalongbrowsercontroller", [
    ...
    function ($scope, $injector, instance) {
      ...
      if (
        !ecEditor._.isUndefined(instance.editorObj) &&
        !ecEditor._.isUndefined(instance.config.audioObj)
      ) {
      ...
      ctrl.finalText = function () {
        ...
        ecEditor._.forEach(textArray, function (text, key) {
          key = key + 1;
          str +=
            '<span class="word" id="word-' + key + '">' + text + " </span>";
        });
