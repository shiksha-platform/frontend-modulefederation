"use strict";
angular
  .module("assetbrowserapp", ["angularAudioRecorder", "angular-inview"])
  .config([
...
angular.module("assetbrowserapp").controller("browsercontroller", [
  ...
  function ($scope, $injector, instance) {
    ...
    setTimeout(function () {
      ...
      ctrl.myTabScrollElement =
        instance.mediaType === "image" ? "my-image-tab" : "my-audio-tab";
      ctrl.allTabScrollElement =
        instance.mediaType === "image" ? "all-image-tab" : "all-audio-tab";
      ...
      ecEditor
        .jQuery(document)
        .on("change", "#assetName, #assetfile", function () {
          ctrl.uploadBtnDisabled = false;
