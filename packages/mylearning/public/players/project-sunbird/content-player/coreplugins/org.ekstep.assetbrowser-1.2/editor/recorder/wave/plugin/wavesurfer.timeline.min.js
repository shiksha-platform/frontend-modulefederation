 ...
 * @license CC-BY-3.0 */ !(function (a, b) {
  ...
  (a.Timeline = {
    ...
    createCanvas: function () {
      ...
      (this.timeCc = a.getContext("2d")),
        this.wavesurfer.drawer.style(a, { position: "absolute", zIndex: 4 });
    },
    render: function () {
      this.updateCanvasStyle(), this.drawTimeCanvas();
    },
    updateCanvasStyle: function () {
      var a = this.drawer.wrapper.scrollWidth;
      (this.canvas.width = a * this.wavesurfer.params.pixelRatio),
    ...
    drawTimeCanvas: function () {
      ...
      if (c > 0) {
        var g = 0,
          ...
          i = parseInt(c, 10) + 1,
          j = function (a) {
            if ("function" == typeof d.formatTimeCallback)
              return d.formatTimeCallback(a);
            if (a / 60 > 1) {
              var b = parseInt(a / 60),
                a = parseInt(a % 60);
        ...
        if (1 * f >= 25)
          ...
          var k = 60,
            l = 4,
            m = 2;
        (k = this.timeInterval || k),
          (l = this.primaryLabelInterval || l),
          (m = this.secondaryLabelInterval || m);
        for (
          var n = this.height - 4,
            o = this.height * (this.notchPercentHeight / 100) - 4,
            p = this.fontSize * b.pixelRatio,
            q = 0;
          i / k > q;
          q++
        )
          q % l == 0
            ? ((this.timeCc.fillStyle = this.primaryColor),
              this.timeCc.fillRect(g, 0, 1, n),
              (this.timeCc.font = p + "px " + this.fontFamily),
              (this.timeCc.fillStyle = this.primaryFontColor),
              this.timeCc.fillText(j(h), g + 5, n))
            : q % m == 0
  ...
  !(function (a, b) {
    ...
    (a.Timeline = {
      ...
      updateCanvasStyle: function () {
        ...
        (this.canvas.width = a * this.wavesurfer.params.pixelRatio),
          (this.canvas.height =
            this.height * this.wavesurfer.params.pixelRatio),
          (this.canvas.style.width = a + "px"),
          (this.canvas.style.height = this.height + "px");
      },
      drawTimeCanvas: function () {
