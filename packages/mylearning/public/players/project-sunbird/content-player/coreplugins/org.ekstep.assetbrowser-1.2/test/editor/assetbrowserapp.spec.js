  ...
  describe("Asset Browser plugin test cases", function () {
    ...
    it("Should invoke ImageSource method", function (done) {
      var event = {
        ...
        type: "click",
        target: { attributes: { src: "src", data_id: { value: "value" } } },
        currentTarget: {
          jQuery311053298653526022251: {
            events: {
              click: [
                { type: "click", origType: "click", guid: 1317, namespace: "" },
              ],
            },
          },
        },
        relatedTarget: null,
        timeStamp: 109850.7999998983,
        jQuery31105329865352602225: true,
        delegateTarget: {
          jQuery311053298653526022251: {
            events: {
              click: [
    ...
    it("Should invoke initPopup method", function (done) {
      var item = {
        code: "org.ekstep0.18118304567970056",
        keywords: ["Test tag", "Story"],
        channel: "in.ekstep",
        language: ["English"],
        mimeType: "image/jpeg",
        idealScreenSize: "normal",
        createdOn: "2018-03-16T08:11:16.000+0000",
        objectType: "Content",
        appId: "ekstep_portal",
        contentDisposition: "inline",
        lastUpdatedOn: "2018-03-16T08:11:16.000+0000",
        contentEncoding: "identity",
        contentType: "Asset",
        identifier: "do_112461571080192000118",
        creator: "Santhosh Vasabhaktula",
        audience: ["Learner"],
        ...
        graph_id: "domain",
        nodeType: "DATA_NODE",
        versionKey: "1521187876000",
        idealScreenDensity: "hdpi",
        framework: "NCF",
        createdBy: "390",
        compatibilityLevel: 1,
        IL_FUNC_OBJECT_TYPE: "Content",
        name: "1 1466405046949",
        IL_UNIQUE_ID: "do_112461571080192000118",
        status: "Draft",
        node_id: 31921,
      };
