describe("Asset Browser plugin", function () {
  ...
  it("Should invoke initPreview method to show the popup", function (done) {
    var event = undefined;
    var data = {};
    var data = { type: "audio", search_filter: {} };
  ...
  it("Should get Asset from Learning platfrom", function (done) {
    ...
    var resp = {
      data: {
        ...
        ver: "3.0",
        ts: "2018-09-11T09:16:01ZZ",
        params: {
          resmsgid: "a0e9f6dc-c22e-4768-a171-b487f8113e24",
          msgid: null,
          err: null,
          status: "successful",
          errmsg: null,
        ...
        result: {
          ...
          content: [
            {
              code: "org.ekstep0.131917571075153",
              keywords: ["Test"],
              downloadUrl:
                "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_1123200393395486721284/artifact/10_1466574879630_1503911060578.mp3",
              channel: "in.ekstep",
              language: ["English"],
              mimeType: "audio/mp3",
              idealScreenSize: "normal",
              createdOn: "2017-08-28T09:04:12.191+0000",
              objectType: "Content",
              contentDisposition: "inline",
              artifactUrl:
                "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_1123200393395486721284/artifact/10_1466574879630_1503911060578.mp3",
              contentEncoding: "identity",
              lastUpdatedOn: "2017-08-28T09:04:20.706+0000",
              contentType: "Asset",
              identifier: "do_1123200393395486721284",
              creator: "Chetan Sachdev",
              audience: ["Learner"],
              visibility: "Default",
              os: ["All"],
              consumerId: "e84015d2-a541-4c07-a53f-e31d4553312b",
              mediaType: "audio",
              osId: "org.ekstep.quiz.app",
              graph_id: "domain",
              nodeType: "DATA_NODE",
              versionKey: "1503911060706",
              idealScreenDensity: "hdpi",
              s3Key:
                "content/do_1123200393395486721284/artifact/10_1466574879630_1503911060578.mp3",
              framework: "NCF",
              size: 16763,
              createdBy: "390",
              compatibilityLevel: 1,
              name: "10 1466574879630",
              status: "Live",
              node_id: 108584,
            },
            {
              code: "org.ekstep0.1875382901703806",
              channel: "in.ekstep",
              language: ["English"],
              mimeType: "audio/mp3",
              idealScreenSize: "normal",
              createdOn: "2017-12-26T10:26:17.415+0000",
              objectType: "Content",
              appId: "ekstep_portal",
              contentDisposition: "inline",
              contentEncoding: "identity",
              lastUpdatedOn: "2017-12-26T10:26:17.415+0000",
              contentType: "Asset",
              identifier: "do_1124050143429836801159",
              creator: "Chetan Sachdev",
              audience: ["Learner"],
              visibility: "Default",
              os: ["All"],
              ...
              graph_id: "domain",
              nodeType: "DATA_NODE",
              versionKey: "1514283977415",
              idealScreenDensity: "hdpi",
              framework: "NCF",
              createdBy: "390",
              compatibilityLevel: 1,
              name: "10 1466574879630 1503911060578",
              status: "Draft",
              node_id: 18584,
            },
          ],
    ...
    ecEditor.getService("search").search = jasmine
      .createSpy()
      .and.callFake(function (requestObj, cb) {
        cb(null, resp);
      });
