angular
  .module("textbookmetaApp", ["ngTagsInput", "Scope.safeApply"])
  .controller("textbookmetaController", [
    "$scope",
    "$timeout",
          ...
          return org.ekstep.services.collectionService
            ...
            .then(function (keywords) {
              return keywords.filter(function (keyword) {
                return (
                  keyword.lemma.toLowerCase().indexOf($query.toLowerCase()) !=
                  -1
                );
              });
            });
