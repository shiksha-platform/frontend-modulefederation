...
org.ekstep.questionbank.EditorPlugin =
  org.ekstep.contenteditor.basePlugin.extend({
    ...
    initialize: function () {
      ...
      var templatePath = ecEditor.resolvePluginResource(
        this.manifest.id,
        this.manifest.ver,
        "editor/questionbankmodal.html"
      );
      var controllerPath = ecEditor.resolvePluginResource(
        this.manifest.id,
        this.manifest.ver,
        "editor/questionbankcontroller.js"
      );
      ecEditor
    ...
    loadHtml: function (event, dataObj) {
      ...
      instance.editData = !ecEditor._.isUndefined(dataObj.data)
        ? dataObj.data
        : "";
