describe("Question bank EditorPlugin", function () {
  ...
  beforeEach(function (done) {
    ...
    editQuestion = {
      ...
      appId: "ekstep_portal",
      options:
        '[{"answer":true,"value":{"type":"text","asset":"1","resvalue":0,"resindex":0}}]',
    ...
    plugins = [
      { id: "org.ekstep.questionunit.mtf", ver: "1.0", type: "plugin" },
      { id: "org.ekstep.questionunit.mcq", ver: "1.0", type: "plugin" },
      { id: "org.ekstep.questionunit.ftb", ver: "1.0", type: "plugin" },
    ];
    ...
    window.addEventListener(
      "org.ekstep.questionbank:saveQuestion",
      function (e) {
        // eslint-disable-line no-unused-vars
        saveQuestion();
      }
  ...
  describe("Question Bank", function () {
    ...
    beforeEach(function () {
      ctrl = $controller("QuestionFormController", {
        $scope: $scope,
    ...
    describe("Delete Question", function () {
      ...
      beforeEach(function () {
        ...
        $scope.questions = [
          ...
          },
          {
            ...
            rhs_options:
              '[{"value":{"type":"mixed","text":"इक","image":"","count":"","audio":"","resvalue":"इक","resindex":0},"index":0}]',
            identifier: "do_212465374744944640119",
            IL_SYS_NODE_TYPE: "DATA_NODE",
            question:
              "Give the match the following in the following question test1",
            consumerId: "2c43f136-c02f-4494-9fb9-fd228e2c77e6",
            graph_id: "domain",
            nodeType: "DATA_NODE",
            version: 2,
      ...
      it("should call delete service", function () {
        ...
        expect(
          ecEditor.getService("assessment").deleteQuestion
        ).toHaveBeenCalled();
      });
