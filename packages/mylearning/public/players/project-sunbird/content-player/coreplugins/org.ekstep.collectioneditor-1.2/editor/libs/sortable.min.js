      ...
      function (a, d, e) {
        return {
          ...
          link: function (f, g, h, i) {
                  ...
                  if (d in B) {
                    if (
                      ("ui-floating" !== d ||
                        ...
                        !e ||
                        (e.floating = c),
                      "ui-preserve-size" === d && (c === !1 || c === !0))
                    ) {
                      var f = A.helper;
                      a.helper = function (a, c) {
                        return (
                          A["ui-preserve-size"] === !0 &&
            ...
            function o(a, b) {
              var c = A["ui-model-items"].replace(/[^,]*>/g, ""),
            ...
            function u(a) {
              return a.parent().find(A["ui-model-items"]).index(a);
            }
            function v() {
              f.$watchCollection("ngModel", function () {
                ...
                (C.start = function (a, d) {
                  if ("auto" === A["ui-floating"]) {
                ...
                (C.update = function (a, b) {
                  ...
                  y.appendTo(h.savedNodesOrigin),
                    b.item.sortable.received && (y = null),
                ...
                (C.stop = function (a, c) {
                  ...
                  if (d && !c.item.sortable.received)
                    ...
                    !d &&
                    !b.equals(g.contents().toArray(), y.toArray())
                  ) {
                    var e = q(g, c, y);
                    e && e.length && (y = y.not(e));
            ...
            function w() {
              i ? v() : e.info("ui.sortable: ngModel not provided!", g),
                g.sortable(A);
            }
            function x() {
              return f.uiSortable && f.uiSortable.disabled
                ? !1
                : (w(), x.cancelWatcher(), (x.cancelWatcher = b.noop), !0);
            }
            var y,
              z,
              A = {},
              ...
              D = { helper: null };
            return (
              b.extend(A, B, a, f.uiSortable),
              b.element.fn && b.element.fn.jquery
                ? ((x.cancelWatcher = b.noop),
                  void (
                    x() ||
                    (x.cancelWatcher = f.$watch("uiSortable.disabled", x))
                  ))
                : void e.error(
