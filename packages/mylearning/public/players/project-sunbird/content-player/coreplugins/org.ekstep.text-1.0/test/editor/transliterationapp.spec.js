describe("transliterationapp", function () {
  ...
  beforeEach(function () {
    ...
    multilineTransliterator = jasmine.createSpyObj(
      "org.ekstep.text.MultilineTransliterator",
      ["transliterate"]
    );
    spyOn(org.ekstep.text.MultilineTransliterator, "create").and.returnValue(
      multilineTransliterator
    );
    spyOn(org.ekstep.contenteditor.api, "getService").and.callFake(function (
      serviceName
    ) {
  ...
  beforeEach(inject(function (_$controller_) {
    ...
    controller = $controller("transliterationController", {
      $scope: $scope,
      instance: instance,
      $q: $q,
    });
  ...
  it("calls MultilineTransliterator service when transliterate button is pressed", function () {
    ...
    expect(
      multilineTransliterator.transliterate.calls.mostRecent().args[0]
    ).toBe("Hello");
    expect(
      multilineTransliterator.transliterate.calls.mostRecent().args[1]
    ).toBe("hi");

    multilineTransliterator.transliterate.calls
      .mostRecent()
      .args[2]("", "à¤¹à¤²à¥Š");
  ...
  it("should add transliterated text to stage and close wizard", function () {
    ...
    expect(instance.createTransliteratedText).toHaveBeenCalledWith(
      "Hello world"
    );
    expect($scope.closeThisDialog).toHaveBeenCalled();
  });
  ...
  it("Should populate languages array after calling getLanguages", function () {
    ...
    var response = {
      data: {
        id: "ekstep.language.list",
        ver: "2.0",
        ts: "2017-04-13T10:01:06ZZ",
        params: {
          resmsgid: "127792fd-a5d2-492a-a87e-eb48891604db",
          msgid: null,
          err: null,
          status: "successful",
          errmsg: null,
          ...
          languages: [
            {
              ...
              name: "Bengali",
              words: 1,
              lastUpdatedOn: "2017-01-29T17:56:07.004+0000",
              liveWords: 0,
              createdOn: "2016-04-13T10:40:14.753+0000",
              status: "Live",
              versionKey: "1485712567004",
            },
            {
              identifier: "lang_en",
              code: "en",
              ...
              name: "English",
              words: 92390,
              lastUpdatedOn: "2017-04-13T07:50:45.465+0000",
              liveWords: -434915,
              status: "Live",
              versionKey: "1492069845465",
            },
            {
              identifier: "lang_gu",
              code: "gu",
              ...
              name: "Gujarati",
              words: 0,
              lastUpdatedOn: "2017-01-29T17:56:29.803+0000",
              liveWords: 0,
              createdOn: "2016-04-13T10:42:16.856+0000",
              status: "Live",
              versionKey: "1485712589803",
            },
            {
              identifier: "lang_hi",
              code: "hi",
              ...
              name: "Hindi",
              words: 95627,
              lastUpdatedOn: "2017-04-13T07:50:45.364+0000",
              liveWords: 3904,
              status: "Live",
              versionKey: "1492069845364",
            },
            {
              identifier: "lang_ka",
              code: "ka",
              ...
              name: "Kannada",
              words: 34305,
              lastUpdatedOn: "2017-04-13T07:50:45.444+0000",
              liveWords: 7118,
              createdOn: "2016-02-05T08:33:58.518+0000",
              status: "Live",
              versionKey: "1492069845444",
            },
            {
              identifier: "lang_mr",
              code: "mr",
              ...
              name: "Marathi",
              words: 4480,
              lastUpdatedOn: "2017-04-13T07:50:45.424+0000",
              liveWords: 4480,
              createdOn: "2016-04-13T10:43:33.485+0000",
              status: "Live",
              versionKey: "1492069845424",
            },
            {
              identifier: "lang_pa",
              code: "pa",
              ...
              name: "Punjabi",
              words: 0,
              lastUpdatedOn: "2017-01-29T17:57:11.502+0000",
              liveWords: 0,
              createdOn: "2016-04-13T10:44:19.675+0000",
              status: "Live",
              versionKey: "1485712631502",
            },
            {
              identifier: "lang_ta",
              code: "ta",
              ...
              name: "Tamil",
              words: 0,
              lastUpdatedOn: "2017-01-29T17:57:24.937+0000",
              liveWords: 0,
              createdOn: "2016-04-13T10:44:44.849+0000",
              status: "Live",
              versionKey: "1485712644937",
            },
            {
              identifier: "lang_te",
              code: "te",
              ...
              name: "Telugu",
              words: 40264,
              lastUpdatedOn: "2017-04-13T07:50:45.395+0000",
              liveWords: -133186,
              createdOn: "2016-04-14T18:59:04.670+0000",
              status: "Live",
              versionKey: "1492069845395",
            },
          ],
        },
      },
...
describe("WordExtractor", function () {
  ...
  it("should get text from the selected text plugin", function () {
    var obj = {
      manifest: { id: "org.ekstep.text" },
      editorObj: { text: "hello world!" },
    };
    spyOn(org.ekstep.contenteditor.api, "getCurrentObject").and.returnValue(
      obj
    );
    var wordExtractor = new org.ekstep.text.WordExtractor();
