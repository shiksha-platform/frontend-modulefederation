...
angular
  .module("transliterationapp", [])
  .controller("transliterationController", [
    "$scope",
    "instance",
    "$q",
    function ($scope, instance, $q) {
      var ctrl = this;
      ...
      var languageService = org.ekstep.contenteditor.api.getService(
        ServiceConstants.LANGUAGE_SERVICE
      );
      var multilineTransliterator =
        org.ekstep.text.MultilineTransliterator.create($q, languageService);
