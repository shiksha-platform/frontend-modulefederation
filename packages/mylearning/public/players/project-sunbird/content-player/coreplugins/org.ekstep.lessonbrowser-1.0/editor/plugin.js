...
org.ekstep.collectioneditor.basePlugin.extend({
  ...
  registerRepo: function (repo) {
    ...
    org.ekstep.contenteditor.api
      .getService("popup")
      .loadNgModules(repo.templateUrl, repo.controllerUrl);
  ...
  getEkstepRepo: function () {
    var repo = new (org.ekstep.collectioneditor.contentProviderRepo.extend({
      ...
      init: function () {
        this.templateUrl = org.ekstep.contenteditor.api.resolvePluginResource(
          "org.ekstep.lessonbrowser",
          "1.0",
          "editor/repoEkstep.html"
        );
        this.controllerUrl = org.ekstep.contenteditor.api.resolvePluginResource(
          "org.ekstep.lessonbrowser",
          "1.0",
          "editor/repoEkstepApp.js"
        );
      },
      getFilters: function () {
