...
formApp.directive("conceptselector", function () {
  ...
  var conceptController = [
    ...
    function ($scope, $rootScope, $controller) {
      ...
      $scope.conceptSelectorMessage = $scope.contentMeta.concepts
        ? "(" + $scope.contentMeta.concepts.length + ") concepts selected"
        : "(0) concepts selected";
      ...
      $scope.callbackFn = function (data) {
        ...
        ecEditor.dispatchEvent("editor:form:change", {
          key: "concepts",
          value: $scope.contentMeta.concepts,
  ...
  return {
    ...
    templateUrl: ecEditor.resolvePluginResource(
      manifest.id,
      manifest.ver,
      "editor/directives/conceptselector/template.html"
    ),
