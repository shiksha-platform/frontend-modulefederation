...
describe("Image Plugin", function () {
  ...
  var imageData = {
    ...
    assetMedia: {
      id: "do_1126964504967577601106",
      src: "https://sunbirddev.blob.core.windows.net/sunbird-content-dev/content/do_1126964504967577601106/artifact/images-9_1548236433043.thumb_1549859679975.jpg",
      type: "image",
    },
    x: 20,
    y: 200,
  ...
  it("should NOT instantiate  itself directly", function () {
    ...
    expect(function () {
      ecEditor
        .instantiatePlugin("org.ekstep.image")
        .toThrow(
          new Error("Error: when instantiating plugin: org.ekstep.image thrown")
        );
    });
  });
  ...
  it("sholud register all the events before dispatching it", function () {
    expect(ecEditor.hasEventListener("org.ekstep.assetbrowser:show")).toBe(
      true
    );
    expect(
      ecEditor.hasEventListener("org.ekstep.image:assetbrowser:open")
    ).toBe(true);
  ...
  it("should thorw error with out exact image data", function () {
    expect(function () {
      ecEditor.dispatchEvent("org.ekstep.image:create", {
        assetMedia: {
          id: "do_1121907048923545601138",
          src: "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_1121907048923545601138/artifact/profile-_1488123156828.png",
          type: "image",
        },
        x: 20,
        y: 20,
