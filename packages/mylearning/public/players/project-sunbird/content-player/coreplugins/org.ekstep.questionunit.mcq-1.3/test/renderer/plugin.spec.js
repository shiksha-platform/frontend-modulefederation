describe("MCQRendererPlugin", function () {
  ...
  beforeAll(function (done) {
    var elem =
      '<div id="preview-mcq-template" class="mcq-selected-option mcq-option-value"><input type="radio" name="radio"></input></div>';
    ...
    questionsetEvent = {
      target: {
        _currentQuestion: {
          ...
          config: {
            __cdata:
              '{"metadata":{"category":"MCQ","title":"Testing question for mcq","language":["English"],"qlevel":"EASY","gradeLevel":["Kindergarten"],"concepts":["C6"],"description":"test","max_score":1},"max_time":0,"max_score":1,"partial_scoring":false,"layout":"Grid","isShuffleOption":true}',
          },
          w: 80,
          h: 85,
          x: 9,
    ...
    currentquesObj = {
      data: {
        question: {
          text: "v2 media",
          image:
            "https://dev.ekstep.in/assets/public/content/do_1123016850062950401107/artifact/black_city_by_fersy-d6vkj2j_1501670533324.jpg",
          audio: "",
          hint: "",
        },
        options: [
  ...
  describe("setQuestionTemplate", function () {
    it("should plugin will initialize", function () {
      expect(org.ekstep.pluginframework.pluginManager.plugins["mcq"]).not.toBe(
        undefined
      );
  ...
  describe("preQuestionShow", function () {
    ...
    it("should check question data not have cdata", function () {
      questionsetEvent.target._currentQuestion.data =
        questionsetEvent.target._currentQuestion.data.__cdata;
      questionsetEvent.target._currentQuestion.config =
        questionsetEvent.target._currentQuestion.config.__cdata;
      ...
      questionsetEvent = {
        target: {
          _currentQuestion: {
            ...
            config: {
              __cdata:
                '{"metadata":{"category":"MCQ","title":"Testing question for mcq","language":["English"],"qlevel":"EASY","gradeLevel":["Kindergarten"],"concepts":["C6"],"description":"test","max_score":1},"max_time":0,"max_score":1,"partial_scoring":false,"layout":"Horizontal","isShuffleOption":false}',
            },
            w: 80,
            h: 85,
            x: 9,
  ...
  describe("checkBaseUrl", function () {
    it("should call the checkBaseUrl function", function () {
      ...
      expect(
        plugin.getAssetUrl("http://localhost:9877/assets/sounds/goodjob.mp3")
      ).toEqual("http://localhost:9877/assets/sounds/goodjob.mp3");
    });
  });
  ...
  describe("selectedvalue", function () {
    it("should call the select option function", function () {
      var event = {};
      event.target =
        '<div class="qc-option-value mcq-option-value" onclick="plugin.selectedvalue(event,{},"0")"><div class="qc-option-text"><div class="qc-opt qc-option-txt-only">v1</div> </div> <div class="qc-option-checkbox"> <input type="radio" name="radio" value="pass" onclick="plugin.logTelemetryInteract(event)" class="qc-option-input-checkbox" id="option"> </div> </div>';
      var index = "0";
