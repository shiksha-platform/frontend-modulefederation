 ...
 */
angular.module("orgEkstepQuestion").controller("mcqQuestionFormController", [
  "$scope",
  "$rootScope",
  "questionServices",
  "$timeout",
      ...
      var addAllMedia = [
        ...
        },
        {
          ...
          src: ecEditor.resolvePluginResource(
            $scope.mcqPluginInstance.id,
            $scope.mcqPluginInstance.ver,
            "renderer/assets/audio-icon3.png"
          ),
        ...
        },
        {
          ...
          src: ecEditor.resolvePluginResource(
            $scope.mcqPluginInstance.id,
            $scope.mcqPluginInstance.ver,
            "renderer/assets/audio_stop.png"
          ),
