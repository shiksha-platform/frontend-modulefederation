...
org.ekstep.mcq.questionComponent = {
  ...
  toggleQuestionText: function (option) {
    if (option && option.layout == "qcontainer-big") {
      if ($(".hiding-container").hasClass("expanded")) {
        ...
        $(".expand-button img").toggleClass("flip");
        $(".hiding-container").css(
          "padding-bottom",
          $(".expand-button").height() + "px"
        );
      ...
      if ($(".hiding-container").hasClass("expanded")) {
        ...
        expandButtonBottom =
          expandButtonBottom -
          ($(".hiding-container").height() - $(".question-container").height());
  ...
  onDomReady: function () {
    ...
    var quesitonUnitPluginVer =
      PluginManager.pluginMap["org.ekstep.questionunit"].m.ver;
    org.ekstep.mcq.questionComponent.loadImageFromUrl(
      $(
        "#org-ekstep-contentrenderer-questionunit-questionComponent-downArwImg"
      ),
      "renderer/assets/down_arrow.png",
      "org.ekstep.questionunit",
      quesitonUnitPluginVer
    );
    org.ekstep.mcq.questionComponent.loadImageFromUrl(
      $("#org-ekstep-contentrenderer-questionunit-questionComponent-AudioImg"),
      "renderer/assets/audio-icon1.png",
      "org.ekstep.questionunit",
      quesitonUnitPluginVer
    );
    org.ekstep.mcq.questionComponent.loadImageFromUrl(
      $("#org-ekstep-contentrenderer-questionunit-questionComponent-ZoomImg"),
      "renderer/assets/zoom.png",
      "org.ekstep.questionunit",
      quesitonUnitPluginVer
    );
    org.ekstep.mcq.questionComponent.loadAssetUrl(
      $("#org-ekstep-questionunit-questionComponent-qimage"),
      $("#org-ekstep-questionunit-questionComponent-qimage").data("image"),
      "org.ekstep.questionunit",
      quesitonUnitPluginVer
    );
  },
...
org.ekstep.mcq.backgroundComponent = {
  ...
  getBackgroundGraphics: function () {
    org.ekstep.mcq.backgroundComponent.settings.bgColor =
      org.ekstep.mcq.backgroundComponent.settings.bgColors[
        _.random(
          0,
          org.ekstep.mcq.backgroundComponent.settings.bgColors.length - 1
        )
      ];
    return '\
