...
!(function () {
  ...
  function c(e) {
    function n(t) {
      var e, n;
      return t && t.nodeType
        ? ((e = x(t).children(".mq-root-block").attr(It)),
  ...
  function p(t, e) {
    (t.jQadd = function () {
      ...
      (t.reflow = function () {
        ...
        Z(this.delimjQs, zt(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
      n = dt[t],
      s = dt[e];
    (j[t] = i(pt, w, t, n, e, s)), (j[n] = i(pt, q, t, n, e, s));
  }
  var m,
    g,
    b,
    ...
    Lt,
    At = window.jQuery,
    Rt = "mathquill-command-id",
    It = "mathquill-block-id",
    zt = Math.min,
    Mt = Math.max;
  if (!At) throw "MathQuill requires jQuery 1.5.2+ to be loaded first";
  (g = [].slice),
    (b = e(function (t, n) {
    ...
    (v = (function (t, e, n) {
      ...
      return function t(n, o) {
        ...
        return (
          ...
          (u = l.prototype = a.prototype = a.p = new r()),
          (u.constructor = a),
          (a.extend = function (e) {
            return t(a, e);
          }),
          (a.open = function (t) {
            if (
              ((h = {}),
              s(t) ? (h = t.call(a, u, c, a, n)) : i(t) && (h = t),
              i(h))
            )
              for (var r in h) e.call(h, r) && (u[r] = h[r]);
            return s(u.init) || (u.init = n), a;
          })(o)
        );
      };
    })(0, {}.hasOwnProperty)),
        ...
        (t.times = function (t, e) {
          ...
          return n(function (n, s, r) {
            ...
            var c,
              ...
              h = [],
              f = !0;
            for (u = 0; u < t; u += 1) if (!(f = i._(n, o, a))) return r(n, c);
            for (; u < e && f; u += 1) f = i._(n, o, l);
            return s(n, h);
          });
        }),
        (t.result = function (t) {
    ...
    _.open(function (t) {
      t.seek = function (t, e, n) {
        ...
        return (
          t &&
            ((i = t.attr(It) || t.attr(Rt)) ||
              ((r = t.parent()), (i = r.attr(It) || r.attr(Rt)))),
      ...
      (D.p.substituteTextarea = function () {
        ...
        (t.staticMathTextareaEvents = function () {
          ...
          this.container.prepend(
            At('<span class="mq-selectable">').text("$" + e.exportLatex() + "$")
          ),
            (e.blurred = !0),
            i
              .bind("cut paste", !1)
      ...
      (t.exportLatex = function () {
        ...
        (t.renderLatexText = function (t) {
          ...
          if (
            ...
            for (u = 0; u < c.length; u += 1) c[u].adopt(h, h.ends[q], 0);
      ...
      (t.init = function (t, n, i) {
        ...
        (t.createBlocks = function () {
          var t,
            ...
            i = n.numBlocks(),
            s = (n.blocks = Array(i));
          for (t = 0; t < i; t += 1) (e = s[t] = H()), e.adopt(n, n.ends[q], 0);
        }),
    ...
    (G = v(O, function (t, e) {
      ...
      (t.ctrlSeq = "\\text"),
        ...
        (t.html = function () {
          return (
            '<span class="mq-text-mode mq-inset" mathquill-command-id=' +
            this.id +
            ">" +
            this.textContents() +
            "</span>"
        ...
        (t.selectTowards = N.prototype.selectTowards),
        (t.deleteTowards = N.prototype.deleteTowards),
        (t.selectOutOf = function (t, e) {
          e.insDirOf(t, this);
        }),
        (t.deleteOutOf = function (t, e) {
          ...
          t.show().deleteSelection(),
            "$" !== n
              ? t[w]
                ...
                : K(n).createLeftOf(t)
              : this.isEmpty()
              ? (t.insRightOf(this), U("\\$", "$").createLeftOf(t))
              : t[q]
              ? t[w]
                ? ((i = G()),
                  (s = this.ends[w]),
            ...
            e.anticursor
              ? e.anticursor.parent === this &&
                ...
                this.anticursorPosition === c
                  ...
                  : (this.anticursorPosition < c
                      ? ((u = e[w].splitRight(this.anticursorPosition)),
                        (e[w] = u))
                      : (u = e[q].splitRight(this.anticursorPosition - c)),
                    (e.anticursor = y(this, u[w], u))))
              : (this.anticursorPosition = e[w] && e[w].text.length);
        }),
        (t.blur = function (t) {
          H.prototype.blur.call(this),
            t &&
              ("" === this.textContents()
                ? (this.remove(),
                  t[w] === this
    ...
    (Q.text = Q.textnormal = Q.textrm = Q.textup = Q.textmd = G),
    (Q.em =
      Q.italic =
      Q.italics =
      Q.emph =
    ...
    (Q.strong = Q.bold = Q.textbf = h("\\textbf", "b", 'class="mq-text-mode"')),
    (Q.sf = Q.textsf =
  ...
  it
    ...
    (Q.mathrm = i(rt, "\\mathrm", "span", 'class="mq-roman mq-font"')),
    (Q.mathit = i(rt, "\\mathit", "i", 'class="mq-font"')),
    (Q.mathbf = i(rt, "\\mathbf", "b", 'class="mq-font"')),
    (Q.mathsf = i(rt, "\\mathsf", "span", 'class="mq-sans-serif mq-font"')),
    (Q.mathtt = i(rt, "\\mathtt", "span", 'class="mq-monospace mq-font"')),
    (Q.underline = i(
      rt,
      "\\underline",
      "span",
    ...
    (Q.overleftrightarrow = i(
      rt,
      "\\overleftrightarrow",
      "span",
      'class="mq-non-leaf mq-overarrow mq-arrow-both"'
    )),
    (Q.overarc = i(rt, "\\overarc", "span", 'class="mq-non-leaf mq-overarc"')),
    (Q.dot = v(N, function (t, e) {
      t.init = function () {
        e.init.call(
          this,
          "\\dot",
        ...
        (t.createLeftOf = function (t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals &&
              (wt("n").createLeftOf(t), Dt().createLeftOf(t));
        }),
        (t.latex = function () {
          function t(t) {
    ...
    (Q["∑"] = Q.sum = Q.summation = i(at, "\\sum ", "&sum;")),
    (Q["∏"] = Q.prod = Q.product = i(at, "\\prod ", "&prod;")),
    (Q.coprod = Q.coproduct = i(at, "\\coprod ", "&#8720;")),
    (Q["∫"] =
      Q.int =
      Q.integral =
        v(at, function (t, e) {
          (t.init = function () {
            P.prototype.init.call(
              this,
              "\\int ",
            ...
            (t.createLeftOf = N.p.createLeftOf);
        })),
    (lt =
      Q.frac =
      Q.dfrac =
    ...
    (ft = v(N, function (t, e) {
      ...
      (t.init = function (t, n, i) {
        var s =
          '<span class="mq-diacritic mq-non-leaf"><span class="mq-diacritic-above">' +
          n +
          '&nbsp;</span><span class="mq-non-leaf mq-inset">&0</span></span>';
        ...
        (t.reflow = function () {
          ...
          e &&
            t.eachChild(function (t) {
              t.ctrlSeq in s || (e = !1), "t" === t.ctrlSeq && (n = !0);
            }),
            this.jQ
              .toggleClass("mq-diacritic-low", e)
              .toggleClass("mq-diacritic-t", n);
        }),
        (n = "acegmnopqrstuvwxyz"),
        (i =
          "alpha gamma eta iota kappa mu nu rho sigma tau chi omega varphi epsilon varepsilon pi varpi varsigma upsilon digamma varkappa varrho psi".split(
            " "
          )),
        (s = {});
      for (r = 0; r < n.length; r += 1) s[n.charAt(r)] = 1;
      for (r = 0; r < i.length; r += 1) s["\\" + i[r] + " "] = 1;
    })),
    (Q.grave = i(ft, "\\grave", "&#x0300;", ["grave(", ")"])),
    (Q.acute = i(ft, "\\acute", "&#x0301;", ["acute(", ")"])),
    (Q.hat = i(ft, "\\hat", "&#x0302;", ["hat(", ")"])),
    (Q.tilde = i(ft, "\\tilde", "&#x0303;", ["tilde(", ")"])),
    (Q.bar = i(ft, "\\bar", "&#x0304;", ["bar(", ")"])),
    (Q.breve = i(ft, "\\breve", "&#x0306;", ["breve(", ")"])),
    (Q.dot = i(ft, "\\dot", "&#x0307;", ["dot(", ")"])),
    (Q.ddot = i(ft, "\\ddot", "&#x0307;", ["ddot(", ")"])),
    (Q.check = i(ft, "\\check", "&#x030C", ["check(", ")"])),
    (Q.vec = i(ft, "\\vec", "&#x20D7;", ["vec(", ")"])),
    (Q.dddot = i(ft, "\\dddots", "&#x20DB;", ["dddot(", ")"])),
    (Q.ddddot = i(ft, "\\dddots", "&#x20DC;", ["ddddot(", ")"])),
    (pt = v(v(N, p), function (e, n) {
    ...
    d("["),
    d("{", "\\{"),
    (Q.langle = i(pt, w, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
    (Q.rangle = i(pt, q, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
    (j["|"] = i(pt, w, "|", "|", "|", "|")),
    (Q.lVert = i(pt, w, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
    (Q.rVert = i(pt, q, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
    (Q.left = v(N, function (t) {
      t.parser = function () {
        var t = B.regex,
          e = B.string,
    ...
    (Q.choose = v(mt, function (t) {
      t.createLeftOf = ct.prototype.createLeftOf;
    })),
    (Q.editable = Q.MathQuillMathField =
      v(N, function (t, e) {
    ...
    (Q["≠"] = Q.ne = Q.neq = i(W, "\\ne ", "&ne;")),
    (Q["∗"] = Q.ast = Q.star = Q.loast = Q.lowast = i(W, "\\ast ", "&lowast;")),
    (Q.therefor = Q.therefore = i(W, "\\therefore ", "&there4;")),
    (Q.cuz = Q.because = i(W, "\\because ", "&#8757;")),
    (Q.prop = Q.propto = i(W, "\\propto ", "&prop;")),
    (Q["≈"] = Q.asymp = Q.approx = i(W, "\\approx ", "&asymp;")),
    (Q.isin = Q.in = i(W, "\\in ", "&isin;")),
    (Q.ni = Q.contains = i(W, "\\ni ", "&ni;")),
    (Q.notni =
      Q.niton =
      Q.notcontains =
      Q.doesnotcontain =
        i(W, "\\not\\ni ", "&#8716;")),
    (Q.sub = Q.subset = i(W, "\\subset ", "&sub;")),
    (Q.sup = Q.supset = Q.superset = i(W, "\\supset ", "&sup;")),
    (Q.nsub =
      Q.notsub =
      Q.nsubset =
      Q.notsubset =
    ...
    (Q.nsup =
      ...
      Q.notsuperset =
        i(W, "\\not\\supset ", "&#8837;")),
    (Q.sube = Q.subeq = Q.subsete = Q.subseteq = i(W, "\\subseteq ", "&sube;")),
    (Q.supe =
      Q.supeq =
      Q.supsete =
      Q.supseteq =
    ...
    (Q.nsupe =
      ...
      Q.notsuperseteq =
        i(W, "\\not\\supseteq ", "&#8841;")),
    (Q.N = Q.naturals = Q.Naturals = i(U, "\\mathbb{N}", "&#8469;")),
    (Q.P =
      Q.primes =
      Q.Primes =
      Q.projective =
      ...
      Q.Probability =
        i(U, "\\mathbb{P}", "&#8473;")),
    (Q.Z = Q.integers = Q.Integers = i(U, "\\mathbb{Z}", "&#8484;")),
    (Q.Q = Q.rationals = Q.Rationals = i(U, "\\mathbb{Q}", "&#8474;")),
    (Q.R = Q.reals = Q.Reals = i(U, "\\mathbb{R}", "&#8477;")),
    (Q.C =
      Q.complex =
      Q.Complex =
      Q.complexes =
    ...
    (Q.H =
      ...
      Q.Quaternions =
        i(U, "\\mathbb{H}", "&#8461;")),
    (Q.quad = Q.emsp = i(U, "\\quad ", "    ")),
    (Q.qquad = i(U, "\\qquad ", "        ")),
    (Q.diamond = i(U, "\\diamond ", "&#9671;")),
    (Q.bigtriangleup = i(U, "\\bigtriangleup ", "&#9651;")),
    (Q.ominus = i(U, "\\ominus ", "&#8854;")),
    (Q.uplus = i(U, "\\uplus ", "&#8846;")),
    (Q.bigtriangledown = i(U, "\\bigtriangledown ", "&#9661;")),
    (Q.sqcap = i(U, "\\sqcap ", "&#8851;")),
    (Q.triangleleft = i(U, "\\triangleleft ", "&#8882;")),
    (Q.sqcup = i(U, "\\sqcup ", "&#8852;")),
    (Q.triangleright = i(U, "\\triangleright ", "&#8883;")),
    (Q.odot = Q.circledot = i(U, "\\odot ", "&#8857;")),
    (Q.bigcirc = i(U, "\\bigcirc ", "&#9711;")),
    (Q.dagger = i(U, "\\dagger ", "&#0134;")),
    (Q.ddagger = i(U, "\\ddagger ", "&#135;")),
    (Q.wr = i(U, "\\wr ", "&#8768;")),
    (Q.amalg = i(U, "\\amalg ", "&#8720;")),
    (Q.models = i(U, "\\models ", "&#8872;")),
    (Q.prec = i(U, "\\prec ", "&#8826;")),
    ...
    (Q.ll = i(U, "\\ll ", "&#8810;")),
    (Q.gg = i(U, "\\gg ", "&#8811;")),
    (Q.parallel = i(U, "\\parallel ", "&#8741;")),
    (Q.nparallel = i(U, "\\nparallel ", "&#8742;")),
    (Q.bowtie = i(U, "\\bowtie ", "&#8904;")),
    (Q.sqsubset = i(U, "\\sqsubset ", "&#8847;")),
    (Q.sqsupset = i(U, "\\sqsupset ", "&#8848;")),
    (Q.smile = i(U, "\\smile ", "&#8995;")),
    (Q.sqsubseteq = i(U, "\\sqsubseteq ", "&#8849;")),
    (Q.sqsupseteq = i(U, "\\sqsupseteq ", "&#8850;")),
    (Q.doteq = i(U, "\\doteq ", "&#8784;")),
    (Q.frown = i(U, "\\frown ", "&#8994;")),
    (Q.vdash = i(U, "\\vdash ", "&#8870;")),
    (Q.dashv = i(U, "\\dashv ", "&#8867;")),
    (Q.nless = i(U, "\\nless ", "&#8814;")),
    (Q.ngtr = i(U, "\\ngtr ", "&#8815;")),
    (Q.longleftarrow = i(U, "\\longleftarrow ", "&#8592;")),
    (Q.longrightarrow = i(U, "\\longrightarrow ", "&#8594;")),
    (Q.Longleftarrow = i(U, "\\Longleftarrow ", "&#8656;")),
    (Q.Longrightarrow = i(U, "\\Longrightarrow ", "&#8658;")),
    (Q.longleftrightarrow = i(U, "\\longleftrightarrow ", "&#8596;")),
    (Q.updownarrow = i(U, "\\updownarrow ", "&#8597;")),
    (Q.Longleftrightarrow = i(U, "\\Longleftrightarrow ", "&#8660;")),
    (Q.Updownarrow = i(U, "\\Updownarrow ", "&#8661;")),
    (Q.mapsto = i(U, "\\mapsto ", "&#8614;")),
    (Q.nearrow = i(U, "\\nearrow ", "&#8599;")),
    (Q.hookleftarrow = i(U, "\\hookleftarrow ", "&#8617;")),
    (Q.hookrightarrow = i(U, "\\hookrightarrow ", "&#8618;")),
    (Q.searrow = i(U, "\\searrow ", "&#8600;")),
    (Q.leftharpoonup = i(U, "\\leftharpoonup ", "&#8636;")),
    (Q.rightharpoonup = i(U, "\\rightharpoonup ", "&#8640;")),
    (Q.swarrow = i(U, "\\swarrow ", "&#8601;")),
    (Q.leftharpoondown = i(U, "\\leftharpoondown ", "&#8637;")),
    (Q.rightharpoondown = i(U, "\\rightharpoondown ", "&#8641;")),
    (Q.nwarrow = i(U, "\\nwarrow ", "&#8598;")),
    (Q.ldots = i(U, "\\ldots ", "&#8230;")),
    (Q.cdots = i(U, "\\cdots ", "&#8943;")),
    (Q.vdots = i(U, "\\vdots ", "&#8942;")),
    ...
    (Q.wp = i(U, "\\wp ", "&#8472;")),
    (Q.bot = i(U, "\\bot ", "&#8869;")),
    (Q.clubsuit = i(U, "\\clubsuit ", "&#9827;")),
    (Q.diamondsuit = i(U, "\\diamondsuit ", "&#9826;")),
    (Q.heartsuit = i(U, "\\heartsuit ", "&#9825;")),
    (Q.spadesuit = i(U, "\\spadesuit ", "&#9824;")),
    (Q.parallelogram = i(U, "\\parallelogram ", "&#9649;")),
    (Q.square = i(U, "\\square ", "&#11036;")),
    (Q.oint = i(U, "\\oint ", "&#8750;")),
    (Q.bigcap = i(U, "\\bigcap ", "&#8745;")),
    (Q.bigcup = i(U, "\\bigcup ", "&#8746;")),
    (Q.bigsqcup = i(U, "\\bigsqcup ", "&#8852;")),
    (Q.bigvee = i(U, "\\bigvee ", "&#8744;")),
    (Q.bigwedge = i(U, "\\bigwedge ", "&#8743;")),
    (Q.bigodot = i(U, "\\bigodot ", "&#8857;")),
    (Q.bigotimes = i(U, "\\bigotimes ", "&#8855;")),
    (Q.bigoplus = i(U, "\\bigoplus ", "&#8853;")),
    (Q.biguplus = i(U, "\\biguplus ", "&#8846;")),
    (Q.lfloor = i(U, "\\lfloor ", "&#8970;")),
    (Q.rfloor = i(U, "\\rfloor ", "&#8971;")),
    (Q.lceil = i(U, "\\lceil ", "&#8968;")),
    (Q.rceil = i(U, "\\rceil ", "&#8969;")),
    (Q.opencurlybrace = Q.lbrace = i(U, "\\lbrace ", "{")),
    (Q.closecurlybrace = Q.rbrace = i(U, "\\rbrace ", "}")),
    (Q.lbrack = i(U, "[")),
    (Q.rbrack = i(U, "]")),
    (Q.slash = i(U, "/")),
    (Q.vert = i(U, "|")),
    (Q.perp = Q.perpendicular = i(U, "\\perp ", "&perp;")),
    (Q.nabla = Q.del = i(U, "\\nabla ", "&nabla;")),
    (Q.hbar = i(U, "\\hbar ", "&#8463;")),
    (Q.AA = Q.Angstrom = Q.angstrom = i(U, "\\text\\AA ", "&#8491;")),
    (Q.ring = Q.circ = Q.circle = i(U, "\\circ ", "&#8728;")),
    (Q.bull = Q.bullet = i(U, "\\bullet ", "&bull;")),
    (Q.setminus = Q.smallsetminus = i(U, "\\setminus ", "&#8726;")),
    (Q.not = Q["¬"] = Q.neg = i(U, "\\neg ", "&not;")),
    (Q["…"] =
      Q.dots =
      Q.ellip =
    ...
    (Q.dArr =
      ...
      Q.Downarrow =
        i(U, "\\Downarrow ", "&dArr;")),
    (Q.diverges = Q.uarr = Q.uparrow = i(U, "\\uparrow ", "&uarr;")),
    (Q.uArr = Q.Uparrow = i(U, "\\Uparrow ", "&uArr;")),
    (Q.to = i(W, "\\to ", "&rarr;")),
    (Q.rarr = Q.rightarrow = i(U, "\\rightarrow ", "&rarr;")),
    (Q.implies = i(W, "\\Rightarrow ", "&rArr;")),
    (Q.rArr = Q.Rightarrow = i(U, "\\Rightarrow ", "&rArr;")),
    (Q.gets = i(W, "\\gets ", "&larr;")),
    (Q.larr = Q.leftarrow = i(U, "\\leftarrow ", "&larr;")),
    (Q.impliedby = i(W, "\\Leftarrow ", "&lArr;"));
  (Q.lArr = Q.Leftarrow = i(U, "\\Leftarrow ", "&lArr;")),
    (Q.harr = Q.lrarr = Q.leftrightarrow = i(U, "\\leftrightarrow ", "&harr;")),
    (Q.iff = i(W, "\\Leftrightarrow ", "&hArr;")),
    (Q.hArr = Q.lrArr = Q.Leftrightarrow = i(U, "\\Leftrightarrow ", "&hArr;")),
    (Q.Re = Q.Real = Q.real = i(U, "\\Re ", "&real;")),
    (Q.Im =
      Q.imag =
      Q.image =
      Q.imagin =
      ...
      Q.Imaginary =
        i(U, "\\Im ", "&image;")),
    (Q.part = Q.partial = i(U, "\\partial ", "&part;")),
    (Q.infty = Q.infin = Q.infinity = i(U, "\\infty ", "&infin;")),
    (Q.alef = Q.alefsym = Q.aleph = Q.alephsym = i(U, "\\aleph ", "&alefsym;")),
    (Q.xist = Q.xists = Q.exist = Q.exists = i(U, "\\exists ", "&exist;")),
    (Q.nexists = Q.nexist = i(U, "\\nexists ", "&#8708;")),
    (Q.and = Q.land = Q.wedge = i(W, "\\wedge ", "&and;")),
    (Q.or = Q.lor = Q.vee = i(W, "\\vee ", "&or;")),
    (Q.o =
      Q.O =
      Q.empty =
      Q.emptyset =
      ...
      Q.nothing =
      Q.varnothing =
        i(W, "\\varnothing ", "&empty;")),
    (Q.cup = Q.union = i(W, "\\cup ", "&cup;")),
    (Q.cap = Q.intersect = Q.intersection = i(W, "\\cap ", "&cap;")),
    (Q.deg = Q.degree = i(U, "\\degree ", "&deg;")),
    (Q.ang = Q.angle = i(U, "\\angle ", "&ang;")),
    (Q.measuredangle = i(U, "\\measuredangle ", "&#8737;")),
    (bt = v(U, function (t, e) {
      t.createLeftOf = function (t) {
        t.options.autoSubscriptNumerals &&
        t.parent !== t.parent.parent.sub &&
        ((t[w] instanceof vt && !1 !== t[w].isItalic) ||
          (t[w] instanceof ot &&
            t[w][w] instanceof vt &&
            !1 !== t[w][w].isItalic))
          ? (Q._().createLeftOf(t),
    ...
    (E.autoCommands = function (t) {
      ...
      for (e = t.split(" "), n = {}, i = 0, s = 0; s < e.length; s += 1) {
        ...
        if (Q[r] === Ot) throw '"' + r + '" is a built-in operator name';
        (n[r] = 1), (i = Mt(i, r.length));
      }
      return (n._maxLength = i), n;
    }),
    (wt = v(vt, function (t, e) {
      function n(t) {
        return !t || t instanceof W || t instanceof at;
      }
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          ...
          if (
            ...
            for (
              s = "", r = this, o = 0;
              r instanceof wt && r.ctrlSeq === r.letter && o < i;
            ...
            for (; s.length; ) {
              if (n.hasOwnProperty(s)) {
                ...
                return (
                  k(r, this).remove(), (t[w] = r[w]), Q[s](s).createLeftOf(t)
                );
              }
              s = s.slice(1);
            }
        ...
        (t.finalizeTree =
          ...
          t.siblingCreated =
            function (t, e) {
              (e !== w && this[q] instanceof wt) || this.autoUnItalicize(t);
            }),
        (t.autoUnItalicize = function (t) {
          ...
          if (0 !== d._maxLength) {
            for (e = this.letter, i = this[w]; i instanceof wt; i = i[w])
              e = i.letter + e;
            for (s = this[q]; s instanceof wt; s = s[q]) e += s.letter;
            ...
            t: for (
              ...
              for (a = zt(d._maxLength, e.length - r); a > 0; a -= 1)
                if (((l = e.slice(r, r + a)), d.hasOwnProperty(l))) {
                  for (c = 0, u = o; c < a; c += 1, u = u[q])
                    u.italicize(!1), (h = u);
                  (f = qt.hasOwnProperty(l)),
                    (o.ctrlSeq = (f ? "\\" : "\\operatorname{") + o.ctrlSeq),
                    (h.ctrlSeq += f ? " " : "}"),
                    yt.hasOwnProperty(l) && h[w][w][w].jQ.addClass("mq-last"),
                    ...
                    n(h[q]) ||
                      (h[q] instanceof ot
                        ...
                        : h.jQ.toggleClass("mq-last", !(h[q] instanceof pt))),
                    (r += a - 1),
                    (o = h);
                  continue t;
                }
    ...
    (qt = {}),
    (xt = D.p.autoOperatorNames = { _maxLength: 9 }),
    (yt = { limsup: 1, liminf: 1, projlim: 1, injlim: 1 }),
    (function () {
      var t,
        e,
        n,
      ...
      for (t = 0; t < s.length; t += 1) qt[s[t]] = xt[s[t]] = 1;
      for (
        e =
    ...
    (Ot = v(P, function (t, e) {
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          var e,
            n = this.ctrlSeq;
          for (e = 0; e < n.length; e += 1) wt(n.charAt(e)).createLeftOf(t);
        }),
        (t.parser = function () {
          var t,
            e = this.ctrlSeq,
          ...
          for (t = 0; t < e.length; t += 1)
            wt(e.charAt(t)).adopt(n, n.ends[q], 0);
          return B.succeed(n.children());
        });
    }));
  for (kt in xt) xt.hasOwnProperty(kt) && (Q[kt] = Ot);
  (Q.operatorname = v(N, function (e) {
    (e.createLeftOf = t),
      (e.numBlocks = function () {
        return 1;
      }),
    ...
    (Q[" "] = Q.space = i(U, "\\ ", "&nbsp;")),
    (Q["'"] = Q.prime = i(U, "'", "&prime;")),
    (Q["″"] = Q.dprime = i(U, "″", "&Prime;")),
    (Q.backslash = i(U, "\\backslash ", "\\")),
    j["\\"] || (j["\\"] = Q.backslash),
    (Q.$ = i(U, "\\$", "$")),
    (Qt = v(P, function (t, e) {
      t.init = function (t, n) {
    ...
    (Q.phi = i(vt, "\\phi ", "&#981;")),
    (Q.phiv = Q.varphi = i(vt, "\\varphi ", "&phi;")),
    (Q.epsilon = i(vt, "\\epsilon ", "&#1013;")),
    (Q.epsiv = Q.varepsilon = i(vt, "\\varepsilon ", "&epsilon;")),
    (Q.piv = Q.varpi = i(vt, "\\varpi ", "&piv;")),
    (Q.sigmaf = Q.sigmav = Q.varsigma = i(vt, "\\varsigma ", "&sigmaf;")),
    (Q.thetav = Q.vartheta = Q.thetasym = i(vt, "\\vartheta ", "&thetasym;")),
    (Q.upsilon = Q.upsi = i(vt, "\\upsilon ", "&upsilon;")),
    (Q.gammad = Q.Gammad = Q.digamma = i(vt, "\\digamma ", "&#989;")),
    (Q.kappav = Q.varkappa = i(vt, "\\varkappa ", "&#1008;")),
    (Q.rhov = Q.varrho = i(vt, "\\varrho ", "&#1009;")),
    (Q.pi = Q["π"] = i(Qt, "\\pi ", "&pi;")),
    (Q.lambda = i(Qt, "\\lambda ", "&lambda;")),
    (Q.Upsilon =
      Q.Upsi =
      Q.upsih =
      Q.Upsih =
        i(P, "\\Upsilon ", '<var style="font-family: serif">&upsih;</var>')),
    (Q.Gamma =
      Q.Delta =
      Q.Theta =
      Q.Lambda =
        ...
        (t.contactWeld =
          ...
          t.siblingDeleted =
            function (t, e) {
              function n(t) {
                return t[w]
                  ? t[w] instanceof W || /^[,;:\(\[]$/.test(t[w].ctrlSeq)
                    ? ""
                    : "mq-binary-operator"
                  : t.parent &&
                    t.parent.parent &&
    ...
    (Q["+"] = i(Tt, "+", "+")),
    (Q["–"] = Q["-"] = i(Tt, "-", "&minus;")),
    (Q["±"] = Q.pm = Q.plusmn = Q.plusminus = i(Tt, "\\pm ", "&plusmn;")),
    (Q.mp = Q.mnplus = Q.minusplus = i(Tt, "\\mp ", "&#8723;")),
    (j["*"] = Q.sdot = Q.cdot = i(W, "\\cdot ", "&middot;", "*")),
    (Ct = v(W, function (t, e) {
      (t.init = function (t, n) {
    ...
    (Q["<"] = Q.lt = i(Ct, _t, !0)),
    (Q[">"] = Q.gt = i(Ct, St, !0)),
    (Q["≤"] = Q.le = Q.leq = i(Ct, _t, !1)),
    (Q["≥"] = Q.ge = Q.geq = i(Ct, St, !1)),
    (Dt = v(W, function (t, e) {
      (t.init = function () {
        e.init.call(this, "=", "=");
      }),
        (t.createLeftOf = function (t) {
          if (t[w] instanceof Ct && t[w].strict)
            return t[w].swap(!1), void t[w].bubble("reflow");
          e.createLeftOf.apply(this, arguments);
        });
    })),
    (Q["="] = Dt),
    (Q["×"] = Q.times = i(W, "\\times ", "&times;", "[x]")),
    (Q["÷"] = Q.div = Q.divide = Q.divides = i(W, "\\div ", "&divide;", "[/]")),
    (j["~"] = Q.sim = i(W, "\\sim ", "~", "~")),
    (Et = c(1));
  for (Lt in Et)
    !(function (t, e) {
