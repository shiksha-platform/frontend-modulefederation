describe("RendererPlugin", function () {
  ...
  var data = {
    ...
    config: {
      __cdata:
        '{"opacity":100,"autoplay":false,"visible":true,"fontfamily":"NotoSans","fontsize":"14px"}',
    },
    rotate: 0,
    "z-index": 1,
    w: 17.46,
  ...
  describe("latexToEquation", function () {
    beforeEach(function () {
      katex.render = jasmine.createSpy("render").and.callFake(function () {
