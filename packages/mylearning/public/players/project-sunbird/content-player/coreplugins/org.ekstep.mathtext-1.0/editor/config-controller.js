angular
  .module("editorApp")
  .controller("org.ekstep.mathtext:config-controller", [
    "$scope",
    function ($scope) {
      ...
      $scope.updateAdvancedTab = function () {
        ...
        $scope.showBackgroundColorpicker(
          "backgroundcolor",
          $scope.configData["backgroundcolor"]
        );
      ...
      ecEditor.addEventListener(
        "org.ekstep.mathtext:add",
        $scope.onTextSelect,
        $scope
      );
      ecEditor.addEventListener(
        "org.ekstep.mathtext:modified",
        $scope.onTextSelect,
        $scope
      );
      ecEditor.addEventListener(
        "org.ekstep.mathtext:unselected",
