describe("Sunbird metadata plugin:", function () {
  ...
  it("Should invoke successAction method after saving form data", function (done) {
    ...
    var data = {
      formData: {
        metaData: {
          ownedBy: "do_112599081812180992167",
          appIcon:
            "https://ekstep-public-dev.s3-ap-south-1.amazonaws.com/content/do_1122027950982266881377/artifact/images_1489599011195.jpeg",
          board: "NCERT",
          gradeLevel: ["Class 1"],
          subject: "Mathematics",
          medium: "English",
          year: "2009",
          name: "Textbook-19th-12",
  ...
  it("Should updateState method to load template", function (done) {
    var object = {
      metaData: {
        ownedBy: "do_21256981223442841614868",
        board: "NCERT",
        gradeLevel: ["KG"],
        subject: "English",
        year: "2004",
      ...
      formConfig: {
        ...
        fields: [
          ...
          },
          {
            code: "dialcode",
            dataType: "list",
            description: "Dialcode",
            editable: true,
            index: 14,
            inputType: "dialcode",
            label: "Dialcode",
            name: "Dialcode",
            placeholder: "Enter Dialcode",
            renderingHints: {},
            required: false,
            visible: true,
          },
