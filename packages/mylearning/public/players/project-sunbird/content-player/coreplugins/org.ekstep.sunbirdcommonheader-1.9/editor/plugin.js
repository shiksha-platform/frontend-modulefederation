org.ekstep.contenteditor.basePlugin.extend({
  ...
  initialize: function () {
    ...
    var templatePath = ecEditor.resolvePluginResource(
      this.manifest.id,
      this.manifest.ver,
      "editor/limitedSharingConfirm.html"
    );
    ...
    var tocErrorPopTemplate = ecEditor.resolvePluginResource(
      this.manifest.id,
      this.manifest.ver,
      "editor/tocErrorPopupTemplate.html"
    );
    var requestQRCodePopupTemplate = ecEditor.resolvePluginResource(
      this.manifest.id,
      this.manifest.ver,
      "editor/requestQRCodePopupTemplate.html"
    );
    ...
    var sendForReviewWarning = ecEditor.resolvePluginResource(
      this.manifest.id,
      this.manifest.ver,
      "editor/sendForReviewWarning.html"
    );
    // ecEditor.getService('popup').loadNgModules(templatePath);
    ecEditor.addEventListener(
      "org.ekstep.checklist:showpopup",
      this.showPopup,
      this
    );
    ecEditor.addEventListener(
