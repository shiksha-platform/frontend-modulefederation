          ...
          r = {
            ...
            updateProgress: function () {
              if (
                ...
                a.Closed &&
                  (clearInterval(s), t.classList.remove(o + "-closed")),
        ...
        setTimeout(function () {
          (e.parentNode.style.height = "0px"),
            ...
            window.setTimeout(function () {
              ...
              "undefined" != typeof s.onClosed &&
                s.onClosed.apply(null, [s, e, i]);
            }, 1e3);
        }, 200),
          "undefined" != typeof s.onClosing &&
            s.onClosing.apply(null, [s, e, i]);
      }),
      (e.show = function (t) {
        var e = this,
          i = g(c, t || {});
        if (
          ...
          i.toastOnce &&
            i.id &&
            document.querySelectorAll("." + o + "#" + i.id).length > 0)
        )
          return !1;
        var s = {
        ...
        s.toast.appendChild(s.toastBody),
          ...
          (function () {
            ...
            i.id && (s.toast.id = i.id),
              ...
              ("" === i.theme && "light" === i.theme) ||
                s.toast.classList.add(o + "-theme-" + i.theme),
              i.color &&
                (v(i.color)
          ...
          i.title.length > 0 &&
            i.message.length > 0 &&
            (s.strong.style.paddingRight = "10px"),
          (function () {
          ...
          (function () {
            if (i.animateInside) {
              ...
              var t = [200, 100, 300];
              if (
                ("bounceInLeft" == i.transitionIn && (t = [400, 200, 400]),
                i.title.length > 0 &&
                  window.setTimeout(function () {
