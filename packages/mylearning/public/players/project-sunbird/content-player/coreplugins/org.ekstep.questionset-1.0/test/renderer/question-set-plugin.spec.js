describe("org.ekstep.questionset", function () {
  ...
  beforeEach(function () {
    data = {
      ...
      config: {
        __cdata:
          '{"title":"test","max_score":3,"allow_skip":true,"show_feedback":false,"shuffle_questions":false,"shuffle_options":false,"total_items":1,"btn_edit":"Edit"}',
      },
    ...
    questionSetPlugin = new org.ekstep.questionsetRenderer(
      data,
  ...
  describe("getQuestionState", function () {
    it("should return question state", function () {
      var res = questionSetPlugin.getQuestionState(
        "0a11ac6d-e801-425a-bd02-a43dea315dc9"
      );
