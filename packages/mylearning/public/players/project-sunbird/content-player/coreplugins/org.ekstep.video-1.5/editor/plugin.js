...
org.ekstep.contenteditor.basePlugin.extend({
  ...
  initialize: function () {
    ecEditor.addEventListener(
      this.manifest.id + ":assetbrowser:open",
      this.openBrowser,
      this
    );
  ...
  newInstance: function () {
    ...
    if (media && media.src) {
      media.src = this.isYoutubeURL(media.src)
        ? media.src
        : ecEditor.getMediaReverseProxyURL(media.src);
    ...
    imageURL = ecEditor.getConfig("useProxyForURL")
      ? "image/get/" + encodeURIComponent(imageURL)
      : imageURL;
  ...
  getMedia: function () {
    ...
    var media = {};
    var videoSrc =
      instance.getConfig()["url"] ||
      instance.media[instance.attributes.asset].src;
