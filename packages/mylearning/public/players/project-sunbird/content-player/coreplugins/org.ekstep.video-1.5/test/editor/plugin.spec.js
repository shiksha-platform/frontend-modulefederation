...
describe("Video plugin", function () {
  var stage,
    ...
    originalTimeout;
  var videoData = {
    asset: "do_11273622562700492812",
    assetMedia: {
      name: "Cartoon",
      id: "do_11273622562700492812",
      src: "https://sunbirddev.blob.core.windows.net/sunbird-content-dev/content/assets/do_11273622562700492812/samplevideo_1280x720_1mb-1.mp4",
      type: "video",
    },
    y: 7.9,
    x: 10.97,
    ...
    config: {
      ...
      muted: false,
      visible: true,
      url: "https://sunbirddev.blob.core.windows.net/sunbird-content-dev/content/assets/do_11273622562700492812/samplevideo_1280x720_1mb-1.mp4",
    },
  };
  ...
  it("should get added video to stage", function () {
    ...
    expect(videoData.assetMedia.src).toEqual(
      video.getMedia()[video.attributes["asset"]].src
    );
  ...
  it("it should validate non Youtube URL", function () {
    video = stage.children[0];
    var url =
      "https://sunbirddev.blob.core.windows.net/sunbird-content-dev/content/assets/do_11273622562700492812/samplevideo_1280x720_1mb-1.mp4";
    video.isYoutubeURL(url);
  ...
  it("should getYoutube", function () {
    ...
    video.getYoutube("myVideo", 20, 5, (a, b) => {
      this.myTest = "test";
    });
