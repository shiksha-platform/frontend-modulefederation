...
(function (factory) {
  ...
  var Comments = {
    ...
    updateToggleAllButton: function (parentEl) {
      ...
      var hiddenReplies = childComments.slice(
        0,
    ...
    replyButtonClicked: function (ev) {
      ...
      if (previousParentId != parentId) {
        ...
        var widget = jQuery(replyField).closest(
          'div[data-jlike-type="annotations"]'
        );
        var instance = "#" + widget.attr("id") + " .jlike-mention";
        var userslistObj = JSON.parse(
          widget.attr("data-jlike-mentionsUserslist")
        );
    ...
    editButtonClicked: function (ev) {
      ...
      textarea.append(
        commentModel.content
          .replace(
            /@\[/g,
            '<span class="atwho-inserted" data-atwho-at-query="@"><a href="' +
              commentModel.profileURL +
              '"><span class="mentionid">@[</span><span class="mentionName">'
          )
          .replace(/]\(/g, '</span><span class="mentionid">](')
          .replace(/\)/g, ")</span></a></span>")
      );

      this.moveCursorToEnd(textarea);

      // @Hack To initialize mentions to comment textarea
      var widget = jQuery(editField).closest(
        'div[data-jlike-type="annotations"]'
      );
    ...
    createCommentWrapperElement: function (commentModel) {
      ...
      // Name
      var nameText = commentModel.createdByCurrentUser
