  ...
  $.fn.hybridtodo = function (options) {
    ...
    function getTodosAndComments(apiRequestParams) {
      jQuery.ajax({
        url:
          ...
          "/index.php?option=com_api&app=jlike&resource=hybridtodos&format=raw",
        headers: {
          "x-auth": "session",
        },
        type: "GET",
    ...
    function createTodo(apiPostParams) {
      jQuery.ajax({
        url:
          ecEditor.getConfig("baseURL") +
          "/index.php?option=com_api&app=jlike&resource=todos&format=raw",
        headers: {
          "x-auth": "session",
        },
        data: apiPostParams,
    ...
    function loadComments(element) {
      ...
      jQuery(element).comments({
        ...
        profilePictureURL: defaults.userProfile.avatar
          ? defaults.userProfile.avatar
          : "",
