...
!(function (global) {
  !(function (e) {
    ...
    function n(e) {
      ...
      return t
        ? ((t = t.charAt(0).toUpperCase() + t.slice(1).toLowerCase()),
          n ? new qq[n]["FineUploader" + t](e) : new qq["FineUploader" + t](e))
        : n
        ? new qq[n].FineUploader(e)
        : new qq.FineUploader(e);
    }
    function i(e, t) {
    ...
    var d,
      p = ["uploaderType", "endpointType"];
    e.fn.fineUploader = function (n) {
      var i = this,
        r = arguments,
        a = [];
      return (
        this.each(function (s, c) {
          if (((d = e(c)), o() && l(n))) {
    ...
    (function (e) {
      "use strict";
      function t(e) {
        e || (e = {}), (e.dropZoneElements = [l]);
        var t = r(e);
        return o(t), i(new qq.DragAndDrop(t)), l;
      }
      function n(e, t) {
        var n = l.data("fineUploaderDnd");
        if (!t) return void 0 === n ? null : n[e];
        void 0 === n && (n = {}), (n[e] = t), l.data("fineUploaderDnd", n);
      }
      function i(e) {
      ...
      function s(e) {
        var t = [];
        return (
          r(Array.prototype.slice.call(arguments, 1), t), i()[e].apply(i(), t)
        );
      }
      var l;
    ...
    return {
      ...
      contains: function (t) {
        return (
          !!t &&
          (e === t ||
            (e.contains ? e.contains(t) : !!(8 & t.compareDocumentPosition(e))))
        );
      },
  ...
  !(function () {
    ...
    (qq.canvasToBlob = function (e, t, n) {
      ...
      (qq.isItemList = function (e) {
        return (
          "[object DataTransferItemList]" === Object.prototype.toString.call(e)
        );
      }),
      ...
      (qq.format = function (e) {
        ...
        return (
          qq.each(t, function (e, t) {
            if (
              ((n = n.substring(0, i) + t + n.substring(i + 2)),
              (i = n.indexOf("{}", i + t.length)),
              i < 0)
            )
              return !1;
          }),
      ...
      (qq.isFile = function (e) {
        return (
          window.File && "[object File]" === Object.prototype.toString.call(e)
        );
      }),
      ...
      (qq.extend = function (e, t, n) {
        return (
          qq.each(t, function (t, i) {
            n && qq.isObject(i)
              ? (void 0 === e[t] && (e[t] = {}), qq.extend(e[t], i, !0))
              : (e[t] = i);
          }),
          e
        );
      ...
      (qq.each = function (e, t) {
        ...
        if (e)
          if (window.Storage && e.constructor === window.Storage)
            ...
            for (
              n = 0;
              n < e.length && ((i = t(n, e.charAt(n))), i !== !1);
              n++
            );
          else
            for (n in e)
      ...
      (qq.bind = function (e, t) {
        if (qq.isFunction(e)) {
          ...
          return function () {
            ...
            return (
              arguments.length &&
                (i = i.concat(Array.prototype.slice.call(arguments))),
              e.apply(t, i)
            );
          };
        }
    ...
    (qq.supportedFeatures = (function () {
      ...
      function s() {
        try {
          return (
            !!window.localStorage && qq.isFunction(window.localStorage.setItem)
          );
        } catch (e) {
          return !1;
        }
    ...
    (qq.Promise = function () {
      ...
      qq.extend(this, {
        then: function (o, a) {
          ...
          return (
            0 === r ? o.push(n) : n.apply(null, void 0 === t ? e : t), this
          );
        },
        success: function () {
          return (
    ...
    (qq.UploadButton = function (e) {
      ...
      function t() {
        ...
        return (
          ...
          a.folders &&
            qq.supportedFeatures.folderSelection &&
    ...
    (function () {
      ...
      (qq.basePublicApi = {
            ...
            e &&
              ...
              qq.each(e, function (e, t) {
                qq.isFileOrInput(t)
                  ...
                  ? a(t)
                  : c.log(
                      t + " is not a valid file container!  Ignoring!",
                      "warn"
                    );
              }),
        ...
        pauseUpload: function (e) {
          ...
          if (
            qq.indexOf(
              [qq.status.UPLOADING, qq.status.UPLOAD_RETRYING],
              t.status
            ) >= 0
          ) {
            ...
            this.log(
              qq.format("Unable to pause file ID {} ({}).", e, this.getName(e)),
              "error"
            );
          } else
            this.log(
              qq.format(
                "Ignoring pause for file ID {} ({}).  Not in progress.",
                e,
                this.getName(e)
              ),
              "error"
        ...
        (qq.basePrivateApi = {
            ...
            return this._uploadData.addFile({
              ...
              onBeforeStatusChange: function (n) {
                e.deleteFileEndpoint &&
                  t.setDeleteFileEndpoint(e.deleteFileEndpoint, n),
                  e.deleteFileParams &&
                    t.setDeleteFileParams(e.deleteFileParams, n),
              ...
              callbacks: {
                ...
                pasteReceived: function (t) {
                  e._handleCheckedCallback({
                    ...
                    callback: qq.bind(
                      e._options.callbacks.onPasteReceived,
                      e,
                      t
                    ),
            ...
            return (
              (n = new qq.UploadButton({
                ...
                ios8BrowserCrashWorkaround:
                  this._options.workarounds.ios8BrowserCrash,
                multiple: t(),
                ...
                title:
                  null == e.title ? this._options.text.fileInputTitle : e.title,
              })),
          ...
          _createUploadHandler: function (e, t) {
            var n = this,
              ...
              o = {
                ...
                log: qq.bind(n.log, n),
                preventRetryParam:
                  this._options.retry.preventRetryResponseProperty,
                onProgress: function (e, t, o, r) {
                  o < 0 ||
                    r < 0 ||
                    (i[e]
                      ? (i[e].loaded === o && i[e].total === r) ||
                        (n._onProgress(e, t, o, r),
                ...
                onUuidChanged: function (e, t) {
                  n.log(
                    "Server requested UUID change from '" +
                      n.getUuid(e) +
                      "' to '" +
                      t +
                      "'"
          ...
          _formatSize: function (e) {
            ...
            while (e > 999);
            return (
              Math.max(e, 0.1).toFixed(1) + this._options.text.sizeSymbols[t]
            );
          },
          ...
          _getButtonId: function (e) {
            var t,
              ...
              i = e;
            if (
              (i instanceof qq.BlobProxy && (i = i.referenceBlob),
              i && !qq.isBlob(i))
            ) {
          ...
          _handleCameraAccess: function () {
            if (this._options.camera.ios && qq.ios()) {
              var e = this._options.camera.button,
                ...
                n = this._options;
              t &&
                t !== this._defaultButtonId &&
                (n = this._extraButtonSpecs[t]),
                (n.multiple = !1),
                null === n.validation.acceptFiles
                  ? (n.validation.acceptFiles = "image/*;capture=camera")
                  : (n.validation.acceptFiles += ",image/*;capture=camera"),
                qq.each(this._buttons, function (e, i) {
                  if (i.getButtonId() === t)
                    return (
                      i.setMultiple(n.multiple),
              ...
              this._formSupport && this._formSupport.attachedToForm
                ? ((this._paramsStore = this._createStore(
                  ...
                  this._formSupport.newEndpoint &&
                    (this._options.request.endpoint =
                      this._formSupport.newEndpoint))
                : (this._paramsStore = this._createStore(
                    this._options.request.params
                  ));
          ...
          _maybeHandleIos8SafariWorkaround: function () {
            var e = this;
            if (
              this._options.workarounds.ios8SafariUploads &&
              qq.ios800() &&
              qq.iosSafari()
            )
              throw (
            ...
            if (!n.success)
              if (i && 200 !== i.status && !n.error)
                this._options.callbacks.onError(
                  e,
                  t,
                  "XHR returned response code " + i.status,
                  i
                );
              else {
                var o = n.error
          ...
          _maybeProcessNextItemAfterOnValidateCallback: function (
            e,
            t,
            n,
            i,
          ...
          _onAllComplete: function (e, t) {
            this._totalProgress &&
              this._totalProgress.onAllComplete(e, t, this._preventRetries),
          ...
          _onAutoRetry: function (e, t, n, i, o) {
            ...
            if (
              ((r._preventRetries[e] =
                n[r._options.retry.preventRetryResponseProperty]),
          ...
          _onBeforeAutoRetry: function (e, t) {
            this.log(
              "Waiting " +
                this._options.retry.autoAttemptDelay +
            ...
            return (
              ...
              this._isDeletePossible()
                ? (this._handleCheckedCallback({
                    name: "onSubmitDelete",
                    callback: qq.bind(
                      this._options.callbacks.onSubmitDelete,
                      this,
                      e
                    ),
                    onSuccess:
            ...
            0 === a || s <= a
              ? t.length > 0
                ? this._handleCheckedCallback({
                    ...
                    onSuccess: qq.bind(
                      this._onValidateCallbackSuccess,
                      this,
                      t,
                      0,
                      n,
                    ...
                    onFailure: qq.bind(
                      this._onValidateCallbackFailure,
                      this,
                      t,
                      0,
                      n,
                    ...
                    identifier:
                      "Item '" + t[0].file.name + "', size: " + t[0].file.size,
                  })
                : this._itemError("noFilesError")
            ...
            this._validateFileOrBlobData(e[t], a).then(
              function () {
                o._upload(e[t].id, n, i),
                  o._maybeProcessNextItemAfterOnValidateCallback(
                    !0,
                    e,
                    r,
                    n,
          ...
          _prepareItemsForUpload: function (e, t, n) {
            ...
            this._handleCheckedCallback({
              ...
              callback: qq.bind(
                this._options.callbacks.onValidateBatch,
                this,
                i,
                r
              ),
    ...
    (function () {
      ...
      (qq.FineUploaderBasic = function (e) {
        ...
        (this._options = {
          ...
          (this._customHeadersStore = this._createStore(
            this._options.request.customHeaders
          )),
          (this._deleteFileCustomHeadersStore = this._createStore(
            this._options.deleteFile.customHeaders
          )),
          (this._deleteFileParamsStore = this._createStore(
            this._options.deleteFile.params
          )),
          (this._endpointStore = this._createStore(
            this._options.request.endpoint
          )),
          (this._deleteFileEndpointStore = this._createStore(
            this._options.deleteFile.endpoint
          )),
          (this._handler = this._createUploadHandler()),
          (this._deleteHandler =
            qq.DeleteFileAjaxRequester && this._createDeleteHandler()),
          this._options.button &&
          ...
          (this._imageGenerator =
            qq.ImageGenerator &&
            new qq.ImageGenerator(qq.bind(this.log, this))),
          ...
          this._scaler.enabled &&
            (this._customNewFileHandler = qq.bind(
              this._scaler.handleNewFile,
              this._scaler
            )),
          qq.TotalProgress &&
    ...
    (qq.AjaxRequester = function (e) {
      ...
      function r(e, t) {
        ...
        return (
          n ||
            ((n = t ? t : S.cors.expected ? o() : qq.createXhrInstance()),
            (y[e].xhr = n)),
          n
        );
      }
      ...
      function u(e, t) {
        ...
        return (
          ...
          i(o)
            ? ((o.onload = h(e)), (o.onerror = f(e)))
            : (o.onreadystatechange = d(e)),
          p(e),
          o.open(a, n, !0),
          S.cors.expected &&
            S.cors.sendCredentials &&
            !i(o) &&
            (o.withCredentials = !0),
          q(e),
          ...
          u
            ...
            : s &&
              S.contentType &&
              S.contentType.toLowerCase().indexOf("application/json") >= 0
      ...
      if (
        (qq.extend(S, e), (_ = S.log), qq.indexOf(S.validMethods, S.method) < 0)
      )
        throw new Error(
          "'" +
            S.method +
      ...
      var n,
                  ...
                  0 === a.blob.size
                    ...
                    : o
                        ...
                        .then(
                          function (t, n) {
                            i(
                              "Chunked upload request succeeded for " +
                                e +
                                ", chunk " +
                                r
                            ),
                            ...
                            var a =
                                o._getFileState(e).chunking.inProgress || [],
          ...
          free: function (e, t) {
            ...
            delete c._openChunks[e],
              p.getProxyOrBlob(e) instanceof qq.BlobProxy &&
                (i(
                  "Generated blob upload has ended for " +
                    e +
                    ", disposing generated blob."
                ),
        ...
        p = {
          ...
          initHandler: function () {
            (o = new (t ? qq[t] : qq.traditional)[
              (qq.supportedFeatures.ajaxUploading ? "Xhr" : "Form") +
                "UploadHandler"
            ](l, {
    ...
    (qq.FormUploadHandler = function (e) {
      ...
      function o(e, t) {
        ...
        (u[f(o)] = t),
          (c[o] = qq(e).attach("load", function () {
            a.getInput(o) &&
              (q(
                "Received iframe load event for CORS upload request (iframe name " +
                  i +
                  ")"
              ),
              (d[i] = setTimeout(function () {
                var e =
                  "No valid message received from loaded iframe for iframe name " +
                  i;
                q(e, "error"), t({ error: e });
              }, 1e3)));
          })),
          m.receiveMessage(i, function (e) {
            ...
            var t,
              ...
              r = o.uuid;
            r && u[r]
              ? (q("Handling response for iframe name " + i),
                clearTimeout(d[i]),
                delete d[i],
      ...
      var r = e.options,
        ...
        f = s.getUuid,
        q = s.log,
        m = new qq.WindowReceiveMessage({ log: q });
        ...
        qq.extend(this, {
          ...
          _initFormForUpload: function (e) {
            var t = e.method,
              ...
              r = e.targetName,
              a = qq.toElement(
                "<form method='" + t + "' enctype='multipart/form-data'></form>"
              ),
              s = n;
            return (
          ...
          _parseJsonResponse: function (e) {
            ...
            try {
              ...
              q(
                "Error when attempting to parse iframe upload response (" +
                  e.message +
                  ")",
                "error"
              );
      ...
      qq.extend(this, new qq.UploadHandler(e)),
        ...
        qq.extend(this, {
          ...
          getResumableFilesData: function () {
            ...
            return (
              n._iterateResumeRecords(function (t, i) {
                n.moveInProgressToRemaining(
                  null,
                  i.chunking.inProgress,
          ...
          reevaluateChunking: function (e) {
            if (r && n.isValid(e)) {
              ...
              if (
                (delete o.chunking,
                (o.chunking = {}),
                (t = n._getTotalChunks(e)),
                t > 1 || r.mandatory)
              ) {
                for (
                  o.chunking.enabled = !0,
                    o.chunking.parts = t,
          ...
          _getChunkData: function (e, t) {
            ...
            return (
              (d[t] = p),
              { part: t, start: s, end: l, count: u, blob: p, size: l - s }
            );
          },
          ...
          _removeExpiredChunkingRecords: function () {
            ...
            n._iterateResumeRecords(function (t, n) {
              ...
              i.setDate(i.getDate() + e),
                i.getTime() <= Date.now() &&
                  (m("Removing expired resume record with key " + t),
          ...
          sendDelete: function (e, t, o) {
            ...
            i.log("Submitting delete file request for " + e),
              "DELETE" === i.method
                ...
                : ((r[i.uuidParamName] = t),
                  n.initTransport(e).withParams(r).send());
          },
        });
    }),
    (function () {
      ...
      function i(e) {
        ...
        if (e.origHeight * e.origWidth > 5241e3)
          return {
              ...
              qq.ios()
                ? (function () {
                    ...
                    var i,
                      ...
                      _ = 0;
                    for (
                      s.width = s.height = a, i = s.getContext("2d");
                      g < p;
    ...
    (qq.ImageGenerator = function (e) {
        ...
        return (
          t(i)
            ...
            : (o.failure(i),
              e(
                qq.format(
                  "Element container of type {} is not supported!",
                  i.tagName
                ),
                "error"
              )),
      ...
      function p(e, t, n, i) {
        u(t, n),
          qq(t).css({ maxWidth: i + "px", maxHeight: i + "px" }),
          (t.src = e);
      }
      function h(e, r, s) {
      ...
      qq.extend(this, {
        generate: function (t, n, i) {
          return qq.isString(t)
            ? (e("Attempting to update thumbnail based on server response."),
              h(t, n, i || {}))
            : (e("Attempting to draw client-side image preview."),
              c(t, n, i || {}));
        },
      }),
        (this._testing = {}),
        ...
        isPreviewableSync: function () {
          ...
          return (
            ...
            !o &&
              t(
                r +
                  " is not previewable in this browser per the blob's type attr"
              ),
            o
          );
        },
        ...
        return (
          new qq.Identify(e, t).isPreviewable().then(function () {
            ...
            o
              ? ((i.onerror = function () {
                  t(
                    "Cannot determine dimensions for image.  May be too large.",
                    "error"
                  ),
                    n.failure();
                }),
      ...
      qq.extend(i, e, !0),
        (this.refresh = function () {
          var e = new qq.Promise(),
            ...
            o = qq.extend({}, i);
          return (
            new qq.SessionAjaxRequester(
              qq.extend(o, { onComplete: t })
            ).queryServer(),
            e
          );
        });
      ...
      qq.extend(this, {
        ...
        getFileRecords: function (e, c, d) {
          var p = this,
            ...
            f = d.blob ? d.blob : d;
          return (
            new qq.Identify(f, t).isPreviewableSync()
              ? (qq.each(u, function (e, i) {
                ...
                h.push({ uuid: e, name: c, size: f.size, blob: i ? f : null }))
              : h.push({ uuid: e, name: c, size: f.size, blob: f }),
            h
          );
        },
    ...
    qq.extend(qq.Scaler.prototype, {
      ...
      _generateScaledImage: function (e, t) {
        ...
        return (
          ...
          p
            .generate(t, h, { maxSize: r, orient: a, customResizeFunction: i })
            .then(
              function () {
              ...
              function () {
                o(
                  "Failed attempt to generate scaled version for " + t.name,
                  "error"
                ),
                  d.failure(u);
              }
      ...
      _form2Obj: function (e) {
        ...
        return (
          qq.each(e.elements, function (e, i) {
            if (
              (!qq.isInput(i, !0) && "textarea" !== i.tagName.toLowerCase()) ||
              !n(i.type) ||
              o(i)
            ) {
      ...
      function n(e, t) {
        ...
        try {
          (i = t.contentDocument || t.contentWindow.document),
            ...
            r &&
              r.match(/^<pre/i) &&
              (r = i.body.firstChild.firstChild.nodeValue),
    ...
    (qq.traditional.XhrUploadHandler = function (e, t) {
      ...
      var n = this,
        ...
        p = function (e, t) {
          return (
            qq.indexOf([200, 201, 202, 203, 204], e.status) < 0 ||
            !t.success ||
            t.reset
          );
        },
        ...
        f = function (e, t) {
          ...
          try {
            ...
            e &&
              a(
                "Error when attempting to parse xhr response text (" +
                  t.message +
                  ")",
                "error"
              );
        ...
        m = function (t, n, a, l) {
          ...
          return (
            ...
            e.paramsInBody ||
              (s || (t[e.inputName] = p), (d = qq.obj2url(t, d))),
            n.open(c, d, !0),
            e.cors.expected &&
              e.cors.sendCredentials &&
              (n.withCredentials = !0),
            s
              ? (e.paramsInBody && qq.obj2FormData(t, u),
          ...
          return {
            finalizeChunks: function (n) {
              return e.chunking.success.endpoint
                ? q(n)
                : t.finalizeChunks(n, qq.bind(f, this, !0));
            },
          };
        });
    }),
      ...
      qq.extend(n, e),
        ...
        qq.extend(this, {
          complete: function (e, o, r, a) {
            ...
            return (
              n.log("Submitting All Chunks Done request for " + e),
              (i[e] = s),
      ...
      function l() {
        ...
        qq.each(e, function (t, n) {
          ...
          e.length &&
            ...
            p.attach(document, "dragenter", function (t) {
              !i.dropDisabled() &&
                a(t) &&
                qq.each(e, function (e, t) {
                  t instanceof HTMLElement &&
                    qq(t).hasAttribute("qq-hide-dropzone") &&
                    qq(t).css({ display: "block" });
                });
            });
        }),
          p.attach(document, "dragleave", function (e) {
            s(e) && t();
          }),
          p.attach(qq(document).children()[0], "mouseenter", function (e) {
            t();
          }),
          p.attach(document, "drop", function (e) {
            e.preventDefault(), t();
          }),
    ...
    (qq.UploadDropZone = function (e) {
      ...
      function i(e) {
        ...
        return (
          (t =
            !(!qq.ie() || !qq.supportedFeatures.fileDrop) ||
            "none" !== n.effectAllowed),
          n &&
            t &&
            (n.files || (!i && n.types.contains && n.types.contains("Files")))
        );
      }
      function o(e) {
      ...
      (qq.uiPublicApi = {
        ...
        reset: function () {
          this._parent.prototype.reset.apply(this, arguments),
            ...
            this._dnd &&
              (this._dnd.dispose(), (this._dnd = this._setupDragAndDrop())),
        ...
        (qq.uiPrivateApi = {
          ...
          _setupClickAndEditEventHandlers: function () {
            (this._fileButtonsClickHandler =
              ...
              this._isEditFilenameEnabled() &&
                ...
                (this._filenameInputFocusInHandler =
                  this._bindFilenameInputFocusInEvent()),
                (this._filenameInputFocusHandler =
          ...
          _filenameEditHandler: function () {
            ...
            return {
              ...
              onEditingStatusChange: function (e, n) {
                ...
                n
                  ? (i.addClass("qq-editing"),
                    t.hideFilename(e),
                    t.hideEditIcon(e))
                  : (i.removeClass("qq-editing"),
                    t.showFilename(e),
                    t.showEditIcon(e)),
            ...
            this._parent.prototype._onUploadStatusChange.apply(this, arguments),
              ...
              t === qq.status.UPLOAD_RETRYING && n === qq.status.UPLOADING
                ? (this._templating.hideRetry(e),
                  ...
                  qq(this._templating.getFileContainer(e)).removeClass(
                    this._classes.retrying
                  ))
                : n === qq.status.UPLOAD_FAILED &&
          ...
          _onSubmitted: function (e) {
            this._isEditFilenameEnabled() &&
              ...
              this._focusinEventSupported ||
                this._filenameInputFocusHandler.addHandler(
                  this._templating.getEditInput(e)
                ));
          },
          _onProgress: function (e, t, n, i) {
              ...
              0 === i || 100 === Math.round((n / i) * 100)
                ? (this._templating.hideCancel(e),
                  ...
                  this._templating.setStatusText(
                    e,
                    this._options.text.waitingForResponse
                  ),
          ...
          _onComplete: function (e, t, n, i) {
            function o(t) {
              s &&
                ...
                a.hideProgress(e),
                l.getUploads({ id: e }).status !== qq.status.UPLOAD_FAILED &&
                  a.hideCancel(e),
                a.hideSpinner(e),
                t.success
          ...
          _onUploadChunk: function (e, t) {
            this._parent.prototype._onUploadChunk.apply(this, arguments),
              t.partIndex > 0 &&
                this._handler.isResumable(e) &&
                this._templating.allowPause(e);
          },
          _onCancel: function (e, t) {
          ...
          _onBeforeAutoRetry: function (e) {
            ...
            this._parent.prototype._onBeforeAutoRetry.apply(this, arguments),
              ...
              this._options.retry.showAutoRetryNote &&
                ...
                (i = this._options.retry.autoRetryNote.replace(
                  /\{retryNum\}/g,
                  t
                )),
                (i = i.replace(/\{maxAuto\}/g, n)),
                this._templating.setStatusText(e, i),
                qq(this._templating.getFileContainer(e)).addClass(
                  this._classes.retrying
                ));
          },
          _onBeforeManualRetry: function (e) {
            return this._parent.prototype._onBeforeManualRetry.apply(
              this,
              arguments
            )
          ...
          _onDeleteComplete: function (e, t, n) {
            this._parent.prototype._onDeleteComplete.apply(this, arguments),
              ...
              n
                ? (this._templating.setStatusText(
                    e,
                    this._options.deleteFile.deletingFailedText
                  ),
          ...
          _sendDeleteRequest: function (e, t, n) {
            this._templating.hideDeleteButton(e),
              ...
              this._templating.setStatusText(
                e,
                this._options.deleteFile.deletingStatusText
              ),
          ...
          _showDeleteConfirm: function (e, t, n) {
            var i,
              o = this.getName(e),
              r = this._options.deleteFile.confirmMessage.replace(
                /\{filename\}/g,
                o
              ),
          ...
          _addToList: function (e, t, n) {
            var i,
              ...
              r = 0,
              a =
                this._handler.isProxied(e) && this._options.scaling.hideScaled;
              ...
              n ||
                ...
                this._options.multiple ||
                  ...
                  (this._handledProxyGroup =
                    this._handledProxyGroup || o.proxyGroupId),
                  (o.proxyGroupId === this._handledProxyGroup &&
                    o.proxyGroupId) ||
                    (this._handler.cancelAll(),
                    this._clearList(),
                    (this._handledProxyGroup = null)))),
              n
                ? (this._templating.addFileToCache(
                    e,
                    this._options.formatFileName(t),
                    i,
                    a
                  ),
            ...
            (n = this._options.failedUploadTextDisplay.mode),
              ...
              "custom" === n
                ? ((o = t[i]),
                  ...
                  this._options.failedUploadTextDisplay.enableTooltip &&
                    this._showTooltip(e, o))
                : "default" === n
                ? this._templating.setStatusText(
                    e,
                ...
                : "none" !== n &&
                  this.log(
                    "failedUploadTextDisplay.mode value of '" +
                      n +
                      "' is not valid",
                    "warn"
                  );
          ...
          _prepareItemsForUpload: function (e, t, n) {
            (this._totalFilesInBatch = e.length),
              (this._filesInBatchAddedToUi = 0),
              this._parent.prototype._prepareItemsForUpload.apply(
                this,
                arguments
              );
          },
          _maybeUpdateThumbnail: function (e) {
            ...
            this.getUploads({ id: e }).status === qq.status.DELETED ||
              (!t &&
          ...
          _addCannedFile: function (e) {
            var t = this._parent.prototype._addCannedFile.apply(
              this,
              arguments
            );
            return (
          ...
          _sessionRequestComplete: function () {
            this._templating.addCacheToDom(),
              this._parent.prototype._sessionRequestComplete.apply(
                this,
                arguments
              );
          },
        ...
        qq.extend(
          this._options,
          {
            ...
            showMessage: function (e) {
              if (n._templating.hasDialog("alert"))
                return n._templating.showDialog("alert", e);
              setTimeout(function () {
                window.alert(e);
              }, 0);
            },
        ...
        (this._templating = new qq.Templating({
          ...
          placeholders: {
            ...
            thumbnailNotAvailable:
              this._options.thumbnails.placeholders.notAvailablePath,
            waitingForThumbnail:
              this._options.thumbnails.placeholders.waitingPath,
          },
    ...
    (qq.Templating = function (e) {
      ...
      var t,
        ...
        s,
        l,
        u = { content: document.createDocumentFragment(), map: {} },
        c = !1,
        d = 0,
        p = !1,
        h = [],
        ...
        b = function () {
          ...
          s &&
            (e
              ? q.imageGenerator.generate(e, new Image(), i).then(
                  function (e) {
                    _.success(e);
                  },
                  function () {
                    _.failure(),
                      t(
                        "Problem loading 'not available' placeholder image at " +
                          e,
                        "error"
                      );
                  }
              ...
              : _.failure(),
            n
              ? q.imageGenerator.generate(n, new Image(), i).then(
                  function (e) {
                    v.success(e);
                  },
                  function () {
                    v.failure(),
                      t(
                        "Problem loading 'waiting for thumbnail' placeholder image at " +
                          n,
                        "error"
                      );
                  }
        ...
        S = function (e, n, i) {
          ...
          return (
            ...
            (n.qqThumbnailId = e),
            q.imageGenerator.generate(n, o, i).then(
              function () {
                d++, W(o), g[e].success();
              },
              function () {
        ...
        k = function (e) {
          return null == e
            ? N(r, m.totalProgressBarContainer) || N(r, m.totalProgressBar)
            : N(P(e), m.progressBarContainer) || N(P(e), m.progressBar);
        },
        A = function (e) {
        ...
        z = function (e, t) {
          ...
          i &&
            ...
            !t.style.maxWidth &&
            !t.style.maxHeight &&
            qq(t).css({ maxWidth: n, maxHeight: i });
        },
        H = function (e, t) {
        ...
        M = function () {
          ...
          if ((t("Parsing template"), null == q.templateIdOrEl))
            throw new Error(
              "You MUST specify either a template element or ID!"
            );
          if (qq.isString(q.templateIdOrEl)) {
            if (((e = document.getElementById(q.templateIdOrEl)), null === e))
              throw new Error(
                qq.format(
                  "Cannot find template script at ID '{}'!",
                  q.templateIdOrEl
                )
              );
            o = e.innerHTML;
          } else {
            if (void 0 === q.templateIdOrEl.innerHTML)
              throw new Error(
          ...
          if (
            ...
            (_ = qq(a).getFirstByClass(m.uploader)),
            q.button &&
              ((c = qq(a).getFirstByClass(m.button)), c && qq(c).remove()),
            (qq.DragAndDrop && qq.supportedFeatures.fileDrop) ||
              ((h = qq(a).getFirstByClass(m.dropProcessing)),
              h && qq(h).remove()),
            (d = qq(a).getFirstByClass(m.drop)),
            d &&
              !qq.DragAndDrop &&
              (t("DnD module unavailable.", "info"), qq(d).remove()),
            qq.supportedFeatures.fileDrop
              ? qq(_).hasAttribute("qq-drop-area-text") &&
                d &&
                ((g = qq(d).getFirstByClass(m.dropText)), g && qq(g).remove())
              : (_.removeAttribute("qq-drop-area-text"),
                d &&
                  qq(d).hasAttribute("qq-hide-dropzone") &&
                  qq(d).css({ display: "none" })),
            (p = qq(a).getFirstByClass(m.thumbnail)),
            s
              ? p &&
                ((f = parseInt(p.getAttribute("qq-max-size"))),
                (f = f > 0 ? f : null),
                (l = qq(p).hasAttribute("qq-server-scale")))
              : p && qq(p).remove(),
            (s = s && p),
            (n = qq(a).getByClass(m.editFilenameInput).length > 0),
            (i = qq(a).getByClass(m.retry).length > 0),
            (r = qq(a).getFirstByClass(m.list)),
            null == r)
          )
            throw new Error(
          ...
          return (
            (u = r.innerHTML),
            (r.innerHTML = ""),
            a.getElementsByTagName("DIALOG").length &&
        ...
        G = function (e) {
          ...
          qq.supportedFeatures.imagePreviews
            ? o
              ? q.limits.maxThumbs && q.limits.maxThumbs <= d
                ? (H(t, o), w())
                : y(o).done(function () {
                    (g[t] = new qq.Promise()),
                      g[t].done(function () {
        ...
        V = function (e) {
          ...
          if (o)
            if (n) {
              if (!(q.limits.maxThumbs && q.limits.maxThumbs <= d))
                return (
                  i && y(o),
                  q.imageGenerator.generate(n, o, r).then(
                    function () {
      ...
      qq.extend(q, e),
        (t = q.log),
        qq.supportedFeatures.imagePreviews ||
          ((q.limits.timeBetweenThumbs = 0), (q.limits.maxThumbs = 0)),
        (r = q.containerEl),
        ...
        qq.extend(this, {
            ...
            s && (u.map[e] = d),
              ...
              i
                ? ((d.style.display = "none"),
                  qq(d).addClass("qq-hidden-forever"))
                : (O(k(e)),
                  O(R(e)),
                  O(E(e)),
                  O(A(e)),
          ...
          hideSpinner: function (e) {
            qq(P(e)).removeClass("qq-in-progress"), O(B(e));
          },
          ...
          generatePreview: function (e, t, n) {
            this.isHiddenForever(e) ||
              (h.push({ id: e, customResizeFunction: n, optFileOrBlob: t }),
              !p && w());
          },
    ...
    (qq.FilenameClickHandler = function (e) {
      ...
      function t(e, t) {
        if (i.templating.isFileName(e) || i.templating.isEditIcon(e)) {
          ...
          i.onGetUploadStatus(o) === qq.status.SUBMITTED &&
            (i.log(
              qq.format(
