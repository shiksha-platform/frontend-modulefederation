angular
  .module("org.ekstep.collectioneditor", ["Scope.safeApply"])
    ...
    function ($scope, $location) {
            ...
            function (err, res) {
              if (res && res.data && res.data.responseCode === "OK") {
                ...
                var frameworkId =
                  ...
                  org.ekstep.services.collectionService.defaultFramwork;
                ecEditor
                  .getService("meta")
                  .getCategorys(frameworkId, function (cateerr, cateresp) {
                    if (!cateerr) {
                      _.forEach(
                        cateresp.data.result.framework.categories,
                        function (category) {
                      ...
                      callback &&
                        callback("unable to fetch categories!", cateresp);
                    }
                  });
              } else {
      ...
      $scope.telemetry = function (data) {
        org.ekstep.services.telemetryService.interact({
          ...
          target: data.target,
          pluginid: "org.ekstep.collectioneditor",
          pluginver: "1.1",
      ...
      $scope.init = function () {
        org.ekstep.services.collectionService.suggestVocabularyRequest.request.limit =
          ecEditor.getConfig("keywordsLimit");
      };
