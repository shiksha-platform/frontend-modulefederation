...
var LightbulbFlashLineIcon = _interopDefault(require('remixicon-react/LightbulbFlashLineIcon'));
var Home4LineIcon = _interopDefault(require('remixicon-react/Home4LineIcon'));
var ParentLineIcon = _interopDefault(require('remixicon-react/ParentLineIcon'));
var FootballLineIcon = _interopDefault(require('remixicon-react/FootballLineIcon'));
var UserFollowLineIcon = _interopDefault(require('remixicon-react/UserFollowLineIcon'));
var Medal2LineIcon = _interopDefault(require('remixicon-react/Medal2LineIcon'));
var ArrowLeftLineIcon = _interopDefault(require('remixicon-react/ArrowLeftLineIcon'));
var More2LineIcon = _interopDefault(require('remixicon-react/More2LineIcon'));
var TeamLineIcon = _interopDefault(require('remixicon-react/TeamLineIcon'));
var GovernmentLineIcon = _interopDefault(require('remixicon-react/GovernmentLineIcon'));
var BookOpenLineIcon = _interopDefault(require('remixicon-react/BookOpenLineIcon'));
var UserLineIcon = _interopDefault(require('remixicon-react/UserLineIcon'));
var ArrowLeftSLineIcon = _interopDefault(require('remixicon-react/ArrowLeftSLineIcon'));
var ArrowRightSLineIcon = _interopDefault(require('remixicon-react/ArrowRightSLineIcon'));
var ArrowUpSLineIcon = _interopDefault(require('remixicon-react/ArrowUpSLineIcon'));
var ArrowDownSLineIcon = _interopDefault(require('remixicon-react/ArrowDownSLineIcon'));
var CalendarCheckLineIcon = _interopDefault(require('remixicon-react/CalendarCheckLineIcon'));
var PencilLineIcon = _interopDefault(require('remixicon-react/PencilLineIcon'));
var CheckboxCircleLineIcon = _interopDefault(require('remixicon-react/CheckboxCircleLineIcon'));
var CloseCircleLineIcon = _interopDefault(require('remixicon-react/CloseCircleLineIcon'));
var CheckboxBlankCircleLineIcon = _interopDefault(require('remixicon-react/CheckboxBlankCircleLineIcon'));
var CheckLineIcon = _interopDefault(require('remixicon-react/CheckLineIcon'));
var Loader4LineIcon = _interopDefault(require('remixicon-react/Loader4LineIcon'));
var UserSmileLineIcon = _interopDefault(require('remixicon-react/UserSmileLineIcon'));
var ListUnorderedIcon = _interopDefault(require('remixicon-react/ListUnorderedIcon'));
var EmotionUnhappyLineIcon = _interopDefault(require('remixicon-react/EmotionUnhappyLineIcon'));
...
function Header(_ref) {
  ...
  return !isDisabledHeader ? !fullRightComponent ? React__default.createElement(nativeBase.Box, Object.assign({}, _box, {
    py: 7,
    px: 5
  }), React__default.createElement(nativeBase.HStack, {
    justifyContent: "space-between",
    alignItems: "center"
  }, React__default.createElement(nativeBase.VStack, null, subHeadingComponent ? subHeadingComponent : React__default.createElement(nativeBase.Text, Object.assign({
    fontSize: "12px"
  }, _subHeading), subHeading), headingComponent ? headingComponent : React__default.createElement(nativeBase.Text, Object.assign({
    bold: true,
    fontSize: "24px"
  }, _heading), title ? title : heading)), iconComponent ? iconComponent : avatar ? React__default.createElement(nativeBase.Avatar, {
    bg: "amber.500"
  }, newAvatar === null || newAvatar === void 0 ? void 0 : newAvatar.toUpperCase().substr(0, 2), React__default.createElement(nativeBase.Avatar.Badge, {
    bg: "green.500",
    top: "0"
...
function IconButton(_ref) {
  ...
  if (!isDisabled) {
    return /*#__PURE__*/React__default.createElement(nativeBase.IconButton, _extends({}, props, {
      icon: React__default.cloneElement(icon, props._icon)
    }));
  } else {
    return /*#__PURE__*/React__default.createElement(nativeBase.Stack, props, icon);
  }
}
...
function Footer(_ref) {
  ...
  var PressableNew = function PressableNew(_ref2) {
    ...
    return item !== null && item !== void 0 && item.route ? /*#__PURE__*/React__default.createElement(nativeBase.Box, prop, /*#__PURE__*/React__default.createElement(reactRouterDom.Link, {
      style: {
        textDecoration: "none"
      },
      to: routeDynamics ? reactRouterDom.generatePath(item.route, _extends({}, {
        id: item.id
      })) : item.route
    }, children)) : /*#__PURE__*/React__default.createElement(nativeBase.Box, prop, children);
  };

  return /*#__PURE__*/React__default.createElement(nativeBase.Stack, null, /*#__PURE__*/React__default.createElement(nativeBase.Box, {
    minH: refFoot === null || refFoot === void 0 ? void 0 : refFoot.clientHeight
  }), /*#__PURE__*/React__default.createElement(nativeBase.Box, {
    flex: 1,
    safeAreaTop: true,
    position: "fixed",
    w: width,
  ...
  }, /*#__PURE__*/React__default.createElement(nativeBase.Center, {
    flex: 1
  }), /*#__PURE__*/React__default.createElement(nativeBase.HStack, {
    bg: "white",
    alignItems: "center",
    safeAreaBottom: true,
    shadow: 6
    ...
    }, /*#__PURE__*/React__default.createElement(nativeBase.Text, {
      color: selected === index ? "button.500" : "coolGray.400"
    }, /*#__PURE__*/React__default.createElement(nativeBase.Center, null, /*#__PURE__*/React__default.createElement(IconByName, {
      name: item.icon
    }), /*#__PURE__*/React__default.createElement(nativeBase.Text, {
      fontSize: "12"
    }, t(item.title)))));
...
function AppBar(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(nativeBase.Box, {
    pt: 7,
    px: 5
  }, /*#__PURE__*/React__default.createElement(nativeBase.StatusBar, {
  ...
  }), searchInput ? /*#__PURE__*/React__default.createElement(nativeBase.Input, {
    bg: "coolGray.100",
    size: "full",
  ...
  }) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null)), /*#__PURE__*/React__default.createElement(nativeBase.HStack, {
    alignItems: "center"
  ...
  }) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null), /*#__PURE__*/React__default.createElement(nativeBase.Center, {
    flex: 1,
    px: "3"
  }, /*#__PURE__*/React__default.createElement(nativeBase.Menu, {
    w: "190",
    trigger: function trigger(triggerProps) {
      return /*#__PURE__*/React__default.createElement(nativeBase.Pressable, _extends({
    ...
    return /*#__PURE__*/React__default.createElement(nativeBase.Menu.Item, {
      key: index,
      label: e.title,
      textValue: e.code,
  ...
  }), /*#__PURE__*/React__default.createElement(nativeBase.Menu.Item, {
    onPress: function onPress(item) {
...
function Layout(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(nativeBase.Stack, {
    width: "100%",
    style: {
  ...
  }, _appBar)) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null), _header ? /*#__PURE__*/React__default.createElement(Header, _header) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null)), subHeader ? /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({
    p: 4,
    position: "relative",
    bg: "purple.400",
    roundedTop: "20",
...
var PressableNew = function PressableNew(_ref) {
  ...
  return route ? /*#__PURE__*/React__default.createElement(nativeBase.Pressable, prop, /*#__PURE__*/React__default.createElement(reactRouterDom.Link, {
    style: {
      color: "rgb(63, 63, 70)",
      textDecoration: "none"
    },
...
function Widget(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(nativeBase.Stack, {
    space: 2
  }, /*#__PURE__*/React__default.createElement(nativeBase.Text, {
    fontSize: "lg"
  }, title), /*#__PURE__*/React__default.createElement(nativeBase.VStack, {
    space: 3
  }, newData.map(function (subData, index) {
    return /*#__PURE__*/React__default.createElement(nativeBase.HStack, {
      key: index,
      space: 3,
      width: "100%"
    }, subData.map(function (item, subIndex) {
      return /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({
        key: subIndex,
        rounded: "xl",
        shadow: 3,
        p: 4,
        ...
        route: item.link
      }, /*#__PURE__*/React__default.createElement(nativeBase.Text, _extends({
        fontSize: "md",
        fontWeight: "medium",
        color: "coolGray.50"
      }, item === null || item === void 0 ? void 0 : item._text), /*#__PURE__*/React__default.createElement(nativeBase.VStack, null, /*#__PURE__*/React__default.createElement(nativeBase.Text, {
        bold: true
      }, item === null || item === void 0 ? void 0 : item.title), /*#__PURE__*/React__default.createElement(nativeBase.Text, {
        fontSize: "xs"
      }, item === null || item === void 0 ? void 0 : item.subTitle))), item.icon ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({}, rotate, {
        bg: "coolGray.700",
        roundedTop: "20px",
        opacity: "0.1"
...
var Collapsible = function Collapsible(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(nativeBase.Box, {
    bg: "white",
    p: 4
  }, /*#__PURE__*/React__default.createElement(nativeBase.Stack, {
    space: 2
  }, /*#__PURE__*/React__default.createElement(nativeBase.Pressable, {
    onPress: function onPress() {
  ...
  })))), /*#__PURE__*/React__default.createElement(nativeBase.PresenceTransition, {
    visible: isOpen,
    initial: {
      opacity: 0
    },
...
function Menu(_ref) {
  ...
  var PressableNew = function PressableNew(_ref2) {
    ...
    return item !== null && item !== void 0 && item.route ? /*#__PURE__*/React__default.createElement(nativeBase.Pressable, prop, /*#__PURE__*/React__default.createElement(reactRouterDom.Link, {
      style: {
        color: "rgb(63, 63, 70)",
        textDecoration: "none"
      },
  ...
  if (type === "veritical") {
    ...
    return /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({
      ...
      return /*#__PURE__*/React__default.createElement(nativeBase.HStack, {
        ...
        }, /*#__PURE__*/React__default.createElement(nativeBase.VStack, {
          space: "2",
          my: "2",
          mx: "1",
          alignItems: "center",
        ...
        }, _icon)) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null), /*#__PURE__*/React__default.createElement(nativeBase.Text, _extends({
          color: "white",
          maxW: 20,
          lineHeight: 14
    ...
    return /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({
      bg: bg
    }, _box), /*#__PURE__*/React__default.createElement(nativeBase.FlatList, {
      data: items,
      renderItem: function renderItem(_ref3) {
        ...
        return /*#__PURE__*/React__default.createElement(nativeBase.Box, _extends({
          ...
          alignItems: "center"
        }, item.leftText ? /*#__PURE__*/React__default.createElement(nativeBase.Text, {
          color: "gray.700",
          fontWeight: "500"
        }, item.leftText) : item.icon ? /*#__PURE__*/React__default.createElement(IconByName, _extends({
          name: item.icon,
          p: "0"
        }, _icon)) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null), /*#__PURE__*/React__default.createElement(nativeBase.Text, {
          color: "gray.700",
          fontWeight: "500"
